...
function [mub,D,G]=mubnd(M,delta,target,display)
...
if nargout>1,
  ...
  if isG,
     G=ScaleG*dec2mat(lmis,xopt,G);  G=G(1:n,1:n)+j*G(1:n,n+1:2*n);
  else 
     G=zeros(2*n); 
  end
end
