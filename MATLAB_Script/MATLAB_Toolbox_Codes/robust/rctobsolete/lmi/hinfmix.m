...
%           value  (default=1e-2)
%  DISPLAY  optional. Displays progress of the LMI solution to the
%           screen [{'On'}, 'Off']. Default is 'On'.
%
% Output:
...
function [gopt,h2opt,K,R,S] = hinfmix(G,sysdim,obj,region,dkbnd,tol,display)
...
elseif nargin<4,
  region=[]; tol=1e-2; dkbnd=100; display='On';
elseif nargin<5,
  tol=1e-2; dkbnd=100; display='On';
elseif nargin<6,
  tol=1e-2; display='On';
elseif nargin<7
  display='On';
