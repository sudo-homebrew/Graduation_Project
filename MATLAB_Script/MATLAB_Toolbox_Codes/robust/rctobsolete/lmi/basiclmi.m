...
%BASICLMI Solves affine LMI.
%
%   X = BASICLMI(M,P,Q,option) computes a solution X to the LMI
%
%         M + P' * X * Q + Q' * X' * P < 0
%
...
%
%   for bases wP and wQ of the null spaces of P and Q. If either 
%   one of these conditions fails to be satisfied, X=[] on output.
%
...
if size(M11,1) > 0,
  ...
  shift=max(toleig*norm(M11(:),1),eps*n*normM);
  [u,t]=schur(-M11);
