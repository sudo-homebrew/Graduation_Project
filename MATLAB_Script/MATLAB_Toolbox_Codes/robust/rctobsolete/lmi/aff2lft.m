%AFF2LFT   Convert affine P-systems to a linear-fractional representation 
%
...
%              | dj |  <=  (pj_max - pj_min)/2
%
%  NOTE: This command is deprecated. Use USS(AFFSYS) to 
%        convert affine systems to USS objects.
%
