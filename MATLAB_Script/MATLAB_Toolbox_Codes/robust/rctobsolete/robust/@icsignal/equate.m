%EQUATE  Equate ICSIGNAL expressions
%   C = EQUATE(A,B) is the ICSIGNAL object capturing the
%   equality of the ICSIGNAL objects A and B.  The Equation
