...
% INPUTS: SYSF -- A SYSTEM in either SS or a MKTITO partitioned SS form; if 
%                 MKTITO ss form then the sector transform is applied to (Uf1,Yf1).
...
%   and SEC=[SEC11,SEC12;SEC21,SEC22] is either a matrix or a MKTITO SS SYSTEM
%   with either 1x1 (scalar) or MxM blocks SEC11,SEC12,SEC21,SEC22.
% OUTPUTS:  SYSG -- G(s) in  same form as F(s) (e.g., SS or MKTITO SS form)
%           SYST -- T(s) in MKTITO SS form; or list of matrices AT,BT1,...,DT22.
%
% See also LFT, MKTITO
