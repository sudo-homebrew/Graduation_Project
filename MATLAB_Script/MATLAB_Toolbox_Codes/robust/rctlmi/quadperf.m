...
%
%   [PERF,P] = QUADPERF(PDS,G,OPTIONS) computes an upper bound on the 
%   worst-case RMS gain of the affine or polytopic parameter-dependent
%   systems PDS.
%
%   If OPTION(1)=0,  QUADPERF estimates the quadratic H-infinity
%   performance (an upper bound on the worst-case I/O gain) of PDS when G=0,
%   or tests whether the performance G >0 can be guaranteed.
%
...
%   region is obtained by scaling the prescribed parameter box around its
...
%    P         Lyapunov matrix P
%
%   See also  ROBUSTPERF, QUADSTAB, PSYS.
