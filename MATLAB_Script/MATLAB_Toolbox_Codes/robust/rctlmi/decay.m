...
%
%   [RATE,P] = DECAY(PDS,OPTIONS) computes the quadratic decay rate of the
%   polytopic or parameter-dependent system PDS (see PSYS)
%
...
%
%   See also  QUADSTAB, ROBUSTSTAB, PDLSTAB.
