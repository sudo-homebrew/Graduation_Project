...
%
%   NEWSYS = DELMVAR(LMISYS,XID) deletes the matrix variable with 
%   identifier XID from the LMI system LMISYS. The updated LMI system, 
%   NEWSYS, is returned. For safety and to easily keep track of 
%   modifications, set XID to the value returned by LMIVAR when Xk was 
%   created.
%
%   See also  SETMVAR, LMIVAR.
