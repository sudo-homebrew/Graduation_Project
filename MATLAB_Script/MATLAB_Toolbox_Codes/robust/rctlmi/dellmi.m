...
%
%   NEWSYS = DELLMI(LMISYS,LMID) removes the LMI with identifier LMID 
%   (see NEWLMI) from the system of LMIs described in LMISYS. LMID is the 
%   ranking of the LMI in the LMI system initially created with 
%   SETLMIS/GETLMIS. To easily keep track of LMIs after deletions, set 
%   LMID to the identifier returned by NEWLMI when this LMI was created.
%   DELLMI returns the updated description of the LMI system, NEWSYS.
%
