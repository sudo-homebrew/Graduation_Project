...
#ifndef SET_LINK_WORLD_POSE_ACTION_HPP
#define SET_LINK_WORLD_POSE_ACTION_HPP
...
/// SetLinkWorldPoseAction sends an Set Link World Pose command to Gazebo server
class SetLinkWorldPoseAction : public Action {
  public:
    SetLinkWorldPoseAction();

    /// setup the link world pose command
    /**
    ...
    1e-9*nanoSeconds
    */
    void setLinkWorldPose(std::string const& modelName,
