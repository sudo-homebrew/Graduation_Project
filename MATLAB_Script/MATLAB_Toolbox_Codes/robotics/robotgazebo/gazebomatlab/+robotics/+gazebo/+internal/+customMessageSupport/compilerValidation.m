...
% the supported compiler list
    ...
    supportedCompilerNameList = containers.Map(archKeys,{'Microsoft Visual C++','g++','Xcode Clang++'});
    supportedCompilerVersionList = containers.Map(archKeys,{'14.0','6.0.0','9.0.0'});
    ...
    installedCompiler = mex.getCompilerConfigurations('CPP','Installed');
    ...
    if(~validSelectedCompiler)
        error(message('robotics:robotgazebo:gazebogenmsg:InvalidSelectedCompiler', selectedCompiler.Name, CompilerListString));
    end
end
