...
#ifndef GAZEBOCOSIM_SET_JOINT_VELOCITY_MSG_HANDLER_HPP
#define GAZEBOCOSIM_SET_JOINT_VELOCITY_MSG_HANDLER_HPP
...
class SetJointVelocityMsgHandler : public MsgHandler {
  public:
    /// Constructor
    /// This class initiated message handler to exchange SetJointVelocity message
    /*
      @param ptr                                  Pointer of Gazebo World Interface
      @param commander                            Reference to the Gazebo apply commander instance
      */
    explicit SetJointVelocityMsgHandler(gazebo::physics::WorldPtr ptr,
    ...
    /**
      ...
      Handles Packet message & construct new Packet message with proper fields
          (Error/ reply content). Based on input message, set velocity of a joint.
