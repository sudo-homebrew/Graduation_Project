...
#ifndef GAZEBOCOSIM_SET_LINEAR_VELOCITY_MSG_HANDLER_HPP
#define GAZEBOCOSIM_SET_LINEAR_VELOCITY_MSG_HANDLER_HPP
...
class SetLinkLinearVelocityMsgHandler : public MsgHandler {
  public:
    /// Constructor
    /// This class initiated message handler to exchange SetLinkLinearVelocity message
    /*
      @param ptr                                  Pointer of Gazebo World Interface
      @param commander                            Reference to the Gazebo apply commander instance
      */
    explicit SetLinkLinearVelocityMsgHandler(
    ...
    /**
      ...
      Handles Packet message & construct new Packet message with proper fields
          (Error/ reply content). Based on input message,set linear velocity of a link.
