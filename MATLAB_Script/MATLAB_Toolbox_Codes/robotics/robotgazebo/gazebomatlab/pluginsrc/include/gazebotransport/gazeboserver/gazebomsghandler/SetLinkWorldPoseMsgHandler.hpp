...
#ifndef GAZEBOCOSIM_SET_LINK_WORLD_POSE_MSG_HANDLER_HPP
#define GAZEBOCOSIM_SET_LINK_WORLD_POSE_MSG_HANDLER_HPP
...
class SetLinkWorldPoseMsgHandler : public MsgHandler {
  public:
    /// Constructor
    /// This class initiated message handler to exchange SetLinkWorldPose message
    /*
      @param ptr                                  Pointer of Gazebo World Interface
      @param commander                            Reference to the Gazebo apply commander instance
      */
    explicit SetLinkWorldPoseMsgHandler(gazebo::physics::WorldPtr ptr,
    ...
    /**
      ...
      Handles Packet message & construct new Packet message with proper fields
          (Error/ reply content). Based on input message, set world pose of a link.
