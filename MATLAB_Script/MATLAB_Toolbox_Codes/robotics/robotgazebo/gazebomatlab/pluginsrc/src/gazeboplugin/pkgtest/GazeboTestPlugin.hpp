...
#ifndef GAZEBOCOSIM_GAZEBOTESTPLUGIN_HPP
#define GAZEBOCOSIM_GAZEBOTESTPLUGIN_HPP
...
/*
This file belongs to GazeboTestPlugin Layer of GazeboCoSim
...
class GazeboTestPlugin : public gazebo::WorldPlugin {
  private:
