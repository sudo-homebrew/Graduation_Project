function tree = twoRevJointBot(varargin)

% NOTE: This is a copy of matlab/toolbox/robotics/robotsimulink/robotslmanip/twoJointRigidBodyTree.m
% which ships with the product for customers. This file is present in
% robotics_simulink_manip component, but to be tested in
% robotics_manipulators as a part of Exporter workflow, this file is being placed here (for easier access).
