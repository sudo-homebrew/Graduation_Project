function tree = twoPrismaticJointBot(varargin)
% This function is for internal use and may be removed in a future release.
%
%TWOPRISMATICJOINTBOT Constructs a rigidBodyTree object with two prismatic joints
%   ROBOT = TWOPRISMATICJOINTBOT returns a rigidBodyTree
...
% 
%   mdhparams = [0   pi/2   0.1 0;
%                0.5 0   0   0; 
%                0.5 0   0   0];
%
%   ROBOT = TWOPRISMATICJOINTBOT(FORMAT) allows the user to define the
...
body1.Joint = rigidBodyJoint('joint1','prismatic');
body1.Joint.setFixedTransform(mdhparams(1,:),'mdh');
body1.Joint.HomePosition = 0.25;
tree.addBody(body1,tree.BaseName);

%Add body2 to rigid body tree
body2 = rigidBody('body2');
body2.Joint = rigidBodyJoint('joint2','prismatic');
body2.Joint.setFixedTransform(mdhparams(2,:),'mdh');
body2.Joint.PositionLimits = [0 1.6];
body2.Joint.HomePosition = 0.8;
