classdef MassMatrixBlock < matlab.System
    % This class is for internal use only. It may be removed in the future.
    
    %MASSMATRIXBLOCK Joint-Space Mass Matrix block system object
    ...
    methods
        function obj = MassMatrixBlock(varargin)
            %MassMatrixBlock Constructor for Joint-Space Mass Matrix block system object
    ...
    methods(Access = protected)
        ...
        function H = stepImpl(obj,q)   
            %stepImpl Call RBT object to generate a solution
            
            H = cast(zeros(numel(q)), 'like', q);
            H(:,:) = cast(robotics.manip.internal.RigidBodyTreeDynamics.massMatrix(obj.TreeInternal, double(q)), 'like', q);
        end
        ...
        function validateInputsImpl(obj,q)
            ...
            validateattributes(q,{'single','double'},{'vector'},'MassMatrixBlock','Config');
        end
        ...
        function out = getOutputSizeImpl(obj)
            ...
            out = [obj.TreeStruct.VelocityNumber obj.TreeStruct.VelocityNumber];
        end
