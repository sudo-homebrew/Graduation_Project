classdef GravityTorqueBlock < matlab.System
    % This class is for internal use only. It may be removed in the future.
    
    %GRAVITYTORQUEBLOCK Gravity Torque block system object
    ...
    methods
        function obj = GravityTorqueBlock(varargin)
            %GravityTorqueBlock Constructor for Gravity Torque block system object
    ...
    methods(Access = protected)
        ...
        function validateInputsImpl(obj,q)
            ...
            validateattributes(q,{'single','double'},{'vector'},'GravityTorqueBlock','Config');
        end
