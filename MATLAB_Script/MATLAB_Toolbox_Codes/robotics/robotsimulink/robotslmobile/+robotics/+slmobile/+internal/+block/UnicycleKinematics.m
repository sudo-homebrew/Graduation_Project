classdef UnicycleKinematics < matlab.System & ...
        robotics.mobile.internal.RoboticsAccess & ...
        robotics.mobile.internal.InternalAccess

    % This class is for internal use only. It may be removed in the future.

    % UNICYCLEKINEMATICS System object for bicycle kinematic model block
    ...
    properties (Constant, Hidden)
        %VehicleInputsMapping - Property to map strings on the popup to inputs to the MATLAB object
        VehicleInputsMapping = {'WheelSpeedHeadingRate', 'VehicleSpeedHeadingRate'}
        
        %VehicleInputsStrOpts
        VehicleInputsStrOpts = getVehicleInputOptions
        
        %VehicleInputsStrSet - String set for VehicleInputsStr
    ...
    methods(Access = protected)
        function setupImpl(obj)
            ...
            obj.KinModel = unicycleKinematics;
    ...
    methods (Access = protected)
        ...
        function validateInputs(obj, input1, input2)
            ...
            switch obj.VehicleInputsStr
               case obj.VehicleInputsStrOpts{1}
                   % Case 1: Wheel Speed & Heading Angular Velocity
                   input1Str = 'phiDot';
                   input2Str = 'omega';
...
function strOptions = getVehicleInputOptions
    ...
    strOptions = {...
            'Wheel Speed & Heading Angular Velocity', ...
            'Vehicle Speed & Heading Angular Velocity', ...
            };
end
