classdef GazeboReadBlockMask < robotics.slcore.internal.block.CommonMessageMaskInternal
%This class is for internal use only. It may be removed in the future.

%GazeboReadBlockMask - Block mask callbacks for Gazebo Read block
...
%   Copyright 2019-2020 The MathWorks, Inc.
    ...
    properties (Constant)
        ...
        TopicSelectorDlg = robotics.slgazebo.internal.dlg.TopicSelectorGazebo('builtin');

        %MsgTypeSelectorDlg Select message selector dialog object
        MsgTypeSelectorDlg = robotics.slgazebo.internal.dlg.MessageTypeSelector('builtin');

        %MaskType - Type of block mask
        MaskType = 'Gazebo Read'
    ...
    methods(Static)
        ...
        function dispatch(methodName, varargin)
            obj = robotics.slgazebo.internal.block.GazeboReadBlockMask();
