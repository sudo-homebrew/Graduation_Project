classdef (Abstract) BlankMsgTypeSelectionMask
%This class is for internal use only. It may be removed in the future.

%BlankMsgTypeSelectionMask - Message mask callbacks for Blank/Custom
%Message block
...
%   Copyright 2021 The MathWorks, Inc.
    ...
    properties
        ...
        MessageGetterType = 'blankMessage';
    end


    methods
        function obj = BlankMsgTypeSelectionMask()
