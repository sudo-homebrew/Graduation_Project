...
%   <a href="matlab:help matlab.System/reset   ">reset</a>           - Resets states of the trackGOSPAMetric
%
...
%   trackAssignmentMetrics, constvel, constacc, constturn
    ...
    methods
        ...
        function out=validateGOSPAProperties(~) %#ok<STOUT>
        end
