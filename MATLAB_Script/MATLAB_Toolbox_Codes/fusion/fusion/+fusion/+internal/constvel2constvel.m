function x = constvel2constvel(x1, x2)
% This function is for internal use and may be removed or modified later.
%constvel2constvel function to convert state or stateCovariance.
%   x  = constvel2constvel(x1, x2) converts the state or stateCovariance.
...
%   velocity 
%   --------------------------------------------------------------------
%   %The input parameters for constvel2constvel are
%   x1 = [1;2;3;4;5;6];
%   x2 = [0;0;0;0;0;0];
%   x  = constvel2constvel(x1, x2)
%
