function varargout = jpdaEvents(varargin)
...
% References: 
% [1] Zhou, Bin, and N. K. Bose. "Multitarget tracking in clutter: Fast
% algorithms for data association." IEEE Transactions on aerospace and
% electronic systems 29.2 (1993): 352-363.
% [2] Fisher, James L., and David P. Casasent, "Fast JPDA Multitarget
% Tracking Algorithm", Applied Optics, 28.2 (1989): 371-376.
...
if nargin == 1
    ...
    nargoutchk(0,2);
    [varargout{1:nargout}] = fusion.internal.assignment.kbestJPDAEvents(varargin{:});
end
