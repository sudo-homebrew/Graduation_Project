function [measurement, bounds] = singermeas(state, varargin)
...
if nargout==1
    measurement = matlabshared.tracking.internal.fusion.accelmeas(state, mfilename, varargin{:});
else
    [measurement,bounds] = matlabshared.tracking.internal.fusion.accelmeas(state, mfilename, varargin{:});
end