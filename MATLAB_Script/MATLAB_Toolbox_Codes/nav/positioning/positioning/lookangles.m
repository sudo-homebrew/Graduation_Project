function [az, el, vis] = lookangles(recPos, satPos, maskAngle)
...
validateattributes(maskAngle, {'numeric'}, ...
    {'scalar', 'real', '>=', 0, '<=', 90});

[vis, az, el] = nav.internal.gnss.satelliteStatus( ...
        recPos, maskAngle, satPos);
end