function [data, info] = cobPickResult
%CobPickResult gives an empty data for cob_pick_place_action/CobPickResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_pick_place_action/CobPickResult';
...
info.MessageType = 'cob_pick_place_action/CobPickResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
