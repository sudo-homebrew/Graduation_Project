function [data, info] = configActionFeedback
%ConfigActionFeedback gives an empty data for interval_intersection/ConfigActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'interval_intersection/ConfigActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.interval_intersection.configFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'interval_intersection/ConfigActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
