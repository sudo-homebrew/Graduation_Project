function [data, info] = linkStates
%LinkStates gives an empty data for gazebo_msgs/LinkStates

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'gazebo_msgs/LinkStates';
...
info.MessageType = 'gazebo_msgs/LinkStates';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
