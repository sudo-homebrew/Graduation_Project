function [data, info] = moveBaseActionResult
%MoveBaseActionResult gives an empty data for move_base_msgs/MoveBaseActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'move_base_msgs/MoveBaseActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.move_base_msgs.moveBaseResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'move_base_msgs/MoveBaseActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
