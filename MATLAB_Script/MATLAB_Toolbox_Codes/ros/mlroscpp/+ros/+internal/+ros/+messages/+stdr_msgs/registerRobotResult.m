function [data, info] = registerRobotResult
%RegisterRobotResult gives an empty data for stdr_msgs/RegisterRobotResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'stdr_msgs/RegisterRobotResult';
[data.Description, info.Description] = ros.internal.ros.messages.stdr_msgs.robotMsg;
info.Description.MLdataType = 'struct';
info.MessageType = 'stdr_msgs/RegisterRobotResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
