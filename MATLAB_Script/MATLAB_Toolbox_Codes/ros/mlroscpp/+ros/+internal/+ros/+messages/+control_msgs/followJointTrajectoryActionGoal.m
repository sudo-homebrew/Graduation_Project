function [data, info] = followJointTrajectoryActionGoal
%FollowJointTrajectoryActionGoal gives an empty data for control_msgs/FollowJointTrajectoryActionGoal

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'control_msgs/FollowJointTrajectoryActionGoal';
[data.Header, info.Header] = ros.internal.ros.messages.std_msgs.header;
info.Header.MLdataType = 'struct';
[data.GoalId, info.GoalId] = ros.internal.ros.messages.actionlib_msgs.goalID;
info.GoalId.MLdataType = 'struct';
[data.Goal, info.Goal] = ros.internal.ros.messages.control_msgs.followJointTrajectoryGoal;
info.Goal.MLdataType = 'struct';
info.MessageType = 'control_msgs/FollowJointTrajectoryActionGoal';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{29} = 'goal.path_tolerance';
info.MatPath{30} = 'goal.path_tolerance.name';
info.MatPath{31} = 'goal.path_tolerance.position';
info.MatPath{32} = 'goal.path_tolerance.velocity';
info.MatPath{33} = 'goal.path_tolerance.acceleration';
info.MatPath{34} = 'goal.goal_tolerance';
info.MatPath{35} = 'goal.goal_tolerance.name';
info.MatPath{36} = 'goal.goal_tolerance.position';
info.MatPath{37} = 'goal.goal_tolerance.velocity';
info.MatPath{38} = 'goal.goal_tolerance.acceleration';
info.MatPath{39} = 'goal.goal_time_tolerance';
info.MatPath{40} = 'goal.goal_time_tolerance.sec';
info.MatPath{41} = 'goal.goal_time_tolerance.nsec';
