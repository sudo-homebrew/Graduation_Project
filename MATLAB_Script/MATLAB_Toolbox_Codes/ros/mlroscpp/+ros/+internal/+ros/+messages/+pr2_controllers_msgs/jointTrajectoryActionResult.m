function [data, info] = jointTrajectoryActionResult
%JointTrajectoryActionResult gives an empty data for pr2_controllers_msgs/JointTrajectoryActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_controllers_msgs/JointTrajectoryActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.pr2_controllers_msgs.jointTrajectoryResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'pr2_controllers_msgs/JointTrajectoryActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
