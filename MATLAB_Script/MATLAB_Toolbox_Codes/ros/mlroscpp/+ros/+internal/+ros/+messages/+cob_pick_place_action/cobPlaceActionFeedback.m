function [data, info] = cobPlaceActionFeedback
%CobPlaceActionFeedback gives an empty data for cob_pick_place_action/CobPlaceActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_pick_place_action/CobPlaceActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.cob_pick_place_action.cobPlaceFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'cob_pick_place_action/CobPlaceActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'feedback.success';
info.MatPath{27} = 'feedback.success.data';
info.MatPath{28} = 'feedback.cob_pick_error_string';
