function [data, info] = remoteAllResponse
%RemoteAll gives an empty data for gateway_msgs/RemoteAllResponse

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'gateway_msgs/RemoteAllResponse';
...
info.MessageType = 'gateway_msgs/RemoteAllResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
