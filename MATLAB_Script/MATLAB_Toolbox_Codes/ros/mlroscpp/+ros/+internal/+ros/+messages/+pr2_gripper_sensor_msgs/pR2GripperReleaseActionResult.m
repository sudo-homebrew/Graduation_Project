function [data, info] = pR2GripperReleaseActionResult
%PR2GripperReleaseActionResult gives an empty data for pr2_gripper_sensor_msgs/PR2GripperReleaseActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_gripper_sensor_msgs/PR2GripperReleaseActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.pr2_gripper_sensor_msgs.pR2GripperReleaseResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'pr2_gripper_sensor_msgs/PR2GripperReleaseActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{27} = 'result.data.rtstate';
info.MatPath{28} = 'result.data.rtstate.realtime_controller_state';
info.MatPath{29} = 'result.data.rtstate.DISABLED';
info.MatPath{30} = 'result.data.rtstate.POSITION_SERVO';
info.MatPath{31} = 'result.data.rtstate.FORCE_SERVO';
info.MatPath{32} = 'result.data.rtstate.FIND_CONTACT';
info.MatPath{33} = 'result.data.rtstate.SLIP_SERVO';
