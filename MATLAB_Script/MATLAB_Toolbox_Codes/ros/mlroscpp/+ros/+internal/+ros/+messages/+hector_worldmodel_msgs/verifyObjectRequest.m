function [data, info] = verifyObjectRequest
%VerifyObject gives an empty data for hector_worldmodel_msgs/VerifyObjectRequest

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'hector_worldmodel_msgs/VerifyObjectRequest';
[data.Object, info.Object] = ros.internal.ros.messages.hector_worldmodel_msgs.object;
info.Object.MLdataType = 'struct';
info.MessageType = 'hector_worldmodel_msgs/VerifyObjectRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
