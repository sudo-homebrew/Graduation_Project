function [data, info] = pr2GripperCommandActionFeedback
%Pr2GripperCommandActionFeedback gives an empty data for pr2_controllers_msgs/Pr2GripperCommandActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_controllers_msgs/Pr2GripperCommandActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.pr2_controllers_msgs.pr2GripperCommandFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'pr2_controllers_msgs/Pr2GripperCommandActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'feedback.position';
info.MatPath{27} = 'feedback.effort';
info.MatPath{28} = 'feedback.stalled';
info.MatPath{29} = 'feedback.reached_goal';
