function [data, info] = goPosActionFeedback
%GoPosActionFeedback gives an empty data for jsk_footstep_controller/GoPosActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'jsk_footstep_controller/GoPosActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.jsk_footstep_controller.goPosFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'jsk_footstep_controller/GoPosActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'feedback.PRE_PLANNING';
info.MatPath{27} = 'feedback.PLANNING';
info.MatPath{28} = 'feedback.WALKING';
info.MatPath{29} = 'feedback.WAITING';
info.MatPath{30} = 'feedback.FINISH';
info.MatPath{31} = 'feedback.status';
info.MatPath{32} = 'feedback.remaining_steps';
