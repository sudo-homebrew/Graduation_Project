function [data, info] = detectObjectsActionFeedback
%DetectObjectsActionFeedback gives an empty data for cob_object_detection_msgs/DetectObjectsActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_object_detection_msgs/DetectObjectsActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.cob_object_detection_msgs.detectObjectsFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'cob_object_detection_msgs/DetectObjectsActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
