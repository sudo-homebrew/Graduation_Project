function [data, info] = goPosActionResult
%GoPosActionResult gives an empty data for jsk_footstep_controller/GoPosActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'jsk_footstep_controller/GoPosActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.jsk_footstep_controller.goPosResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'jsk_footstep_controller/GoPosActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
