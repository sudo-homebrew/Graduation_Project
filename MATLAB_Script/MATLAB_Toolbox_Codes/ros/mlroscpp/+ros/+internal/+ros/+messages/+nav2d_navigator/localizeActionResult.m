function [data, info] = localizeActionResult
%LocalizeActionResult gives an empty data for nav2d_navigator/LocalizeActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'nav2d_navigator/LocalizeActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.nav2d_navigator.localizeResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'nav2d_navigator/LocalizeActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
