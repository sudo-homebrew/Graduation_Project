...
%ExecFootstepsActionResult gives an empty data for jsk_footstep_msgs/ExecFootstepsActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'jsk_footstep_msgs/ExecFootstepsActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.jsk_footstep_msgs.execFootstepsResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'jsk_footstep_msgs/ExecFootstepsActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
