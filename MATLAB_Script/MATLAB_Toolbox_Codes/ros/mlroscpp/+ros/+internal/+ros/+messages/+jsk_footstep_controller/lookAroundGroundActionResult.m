function [data, info] = lookAroundGroundActionResult
%LookAroundGroundActionResult gives an empty data for jsk_footstep_controller/LookAroundGroundActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'jsk_footstep_controller/LookAroundGroundActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.jsk_footstep_controller.lookAroundGroundResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'jsk_footstep_controller/LookAroundGroundActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
