...
%BoundingBox gives an empty data for jsk_pcl_ros/BoundingBox

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'jsk_pcl_ros/BoundingBox';
...
info.MessageType = 'jsk_pcl_ros/BoundingBox';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{17} = 'dimensions';
info.MatPath{18} = 'dimensions.x';
info.MatPath{19} = 'dimensions.y';
info.MatPath{20} = 'dimensions.z';
