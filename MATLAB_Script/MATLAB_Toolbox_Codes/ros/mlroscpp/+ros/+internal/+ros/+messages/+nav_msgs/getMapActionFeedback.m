function [data, info] = getMapActionFeedback
%GetMapActionFeedback gives an empty data for nav_msgs/GetMapActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'nav_msgs/GetMapActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.nav_msgs.getMapFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'nav_msgs/GetMapActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
