function [data, info] = testRequestActionResult
%TestRequestActionResult gives an empty data for actionlib/TestRequestActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'actionlib/TestRequestActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.actionlib.testRequestResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'actionlib/TestRequestActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'result.the_result';
info.MatPath{27} = 'result.is_simple_server';
