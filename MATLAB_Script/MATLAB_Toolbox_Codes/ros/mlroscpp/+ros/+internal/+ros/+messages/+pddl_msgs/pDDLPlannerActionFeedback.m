function [data, info] = pDDLPlannerActionFeedback
%PDDLPlannerActionFeedback gives an empty data for pddl_msgs/PDDLPlannerActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pddl_msgs/PDDLPlannerActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.pddl_msgs.pDDLPlannerFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'pddl_msgs/PDDLPlannerActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
