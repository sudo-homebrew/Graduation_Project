...
%ConfigActionResult gives an empty data for image_cb_detector/ConfigActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'image_cb_detector/ConfigActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.image_cb_detector.configResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'image_cb_detector/ConfigActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
