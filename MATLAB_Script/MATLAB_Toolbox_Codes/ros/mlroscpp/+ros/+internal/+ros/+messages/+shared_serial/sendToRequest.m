function [data, info] = sendToRequest
%SendTo gives an empty data for shared_serial/SendToRequest

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'shared_serial/SendToRequest';
...
info.MessageType = 'shared_serial/SendToRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
