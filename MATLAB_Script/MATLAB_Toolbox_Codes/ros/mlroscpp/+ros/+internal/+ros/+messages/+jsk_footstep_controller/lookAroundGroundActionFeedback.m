function [data, info] = lookAroundGroundActionFeedback
%LookAroundGroundActionFeedback gives an empty data for jsk_footstep_controller/LookAroundGroundActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'jsk_footstep_controller/LookAroundGroundActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.jsk_footstep_controller.lookAroundGroundFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'jsk_footstep_controller/LookAroundGroundActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
