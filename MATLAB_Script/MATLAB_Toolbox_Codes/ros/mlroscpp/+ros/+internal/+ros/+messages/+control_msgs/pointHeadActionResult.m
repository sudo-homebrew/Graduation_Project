...
%PointHeadActionResult gives an empty data for control_msgs/PointHeadActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'control_msgs/PointHeadActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.control_msgs.pointHeadResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'control_msgs/PointHeadActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
