function [data, info] = serviceRequestDetailsResponse
%ServiceRequestDetails gives an empty data for rosapi/ServiceRequestDetailsResponse

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'rosapi/ServiceRequestDetailsResponse';
...
info.MessageType = 'rosapi/ServiceRequestDetailsResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
