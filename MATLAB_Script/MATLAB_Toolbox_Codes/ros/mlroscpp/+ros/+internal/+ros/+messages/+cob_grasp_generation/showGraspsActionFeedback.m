function [data, info] = showGraspsActionFeedback
%ShowGraspsActionFeedback gives an empty data for cob_grasp_generation/ShowGraspsActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_grasp_generation/ShowGraspsActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.cob_grasp_generation.showGraspsFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'cob_grasp_generation/ShowGraspsActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
