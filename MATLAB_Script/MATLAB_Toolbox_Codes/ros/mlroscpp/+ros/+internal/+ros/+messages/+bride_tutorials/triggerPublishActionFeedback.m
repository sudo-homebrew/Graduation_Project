function [data, info] = triggerPublishActionFeedback
%TriggerPublishActionFeedback gives an empty data for bride_tutorials/TriggerPublishActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'bride_tutorials/TriggerPublishActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.bride_tutorials.triggerPublishFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'bride_tutorials/TriggerPublishActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
