function [data, info] = execFootstepsResult
%ExecFootstepsResult gives an empty data for humanoid_nav_msgs/ExecFootstepsResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'humanoid_nav_msgs/ExecFootstepsResult';
...
info.MessageType = 'humanoid_nav_msgs/ExecFootstepsResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
