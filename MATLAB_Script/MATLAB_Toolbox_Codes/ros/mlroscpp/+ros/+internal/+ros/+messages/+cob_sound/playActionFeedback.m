function [data, info] = playActionFeedback
%PlayActionFeedback gives an empty data for cob_sound/PlayActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_sound/PlayActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.cob_sound.playFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'cob_sound/PlayActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
