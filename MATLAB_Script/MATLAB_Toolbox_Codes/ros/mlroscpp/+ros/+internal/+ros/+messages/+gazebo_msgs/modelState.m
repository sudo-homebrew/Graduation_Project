function [data, info] = modelState
%ModelState gives an empty data for gazebo_msgs/ModelState

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'gazebo_msgs/ModelState';
...
info.MessageType = 'gazebo_msgs/ModelState';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
