function [data, info] = assembleScans2Request
%AssembleScans2 gives an empty data for laser_assembler/AssembleScans2Request

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'laser_assembler/AssembleScans2Request';
...
info.MessageType = 'laser_assembler/AssembleScans2Request';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
