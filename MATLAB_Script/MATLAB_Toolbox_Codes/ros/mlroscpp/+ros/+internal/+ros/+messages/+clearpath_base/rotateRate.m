function [data, info] = rotateRate
%RotateRate gives an empty data for clearpath_base/RotateRate

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'clearpath_base/RotateRate';
...
info.MessageType = 'clearpath_base/RotateRate';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
