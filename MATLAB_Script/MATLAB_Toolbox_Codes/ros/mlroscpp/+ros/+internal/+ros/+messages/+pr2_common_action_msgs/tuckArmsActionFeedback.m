function [data, info] = tuckArmsActionFeedback
%TuckArmsActionFeedback gives an empty data for pr2_common_action_msgs/TuckArmsActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_common_action_msgs/TuckArmsActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.pr2_common_action_msgs.tuckArmsFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'pr2_common_action_msgs/TuckArmsActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
