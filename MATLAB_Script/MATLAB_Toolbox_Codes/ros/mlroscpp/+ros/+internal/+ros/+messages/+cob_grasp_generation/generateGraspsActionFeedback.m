...
%GenerateGraspsActionFeedback gives an empty data for cob_grasp_generation/GenerateGraspsActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_grasp_generation/GenerateGraspsActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.cob_grasp_generation.generateGraspsFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'cob_grasp_generation/GenerateGraspsActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
