function [data, info] = twoIntsActionGoal
%TwoIntsActionGoal gives an empty data for actionlib/TwoIntsActionGoal

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'actionlib/TwoIntsActionGoal';
[data.Header, info.Header] = ros.internal.ros.messages.std_msgs.header;
info.Header.MLdataType = 'struct';
[data.GoalId, info.GoalId] = ros.internal.ros.messages.actionlib_msgs.goalID;
info.GoalId.MLdataType = 'struct';
[data.Goal, info.Goal] = ros.internal.ros.messages.actionlib.twoIntsGoal;
info.Goal.MLdataType = 'struct';
info.MessageType = 'actionlib/TwoIntsActionGoal';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{13} = 'goal.a';
info.MatPath{14} = 'goal.b';
