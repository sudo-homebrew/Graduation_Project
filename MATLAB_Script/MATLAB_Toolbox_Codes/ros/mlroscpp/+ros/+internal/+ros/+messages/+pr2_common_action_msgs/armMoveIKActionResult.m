function [data, info] = armMoveIKActionResult
%ArmMoveIKActionResult gives an empty data for pr2_common_action_msgs/ArmMoveIKActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_common_action_msgs/ArmMoveIKActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.pr2_common_action_msgs.armMoveIKResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'pr2_common_action_msgs/ArmMoveIKActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
