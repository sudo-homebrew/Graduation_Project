...
%SingleJointPositionActionFeedback gives an empty data for pr2_controllers_msgs/SingleJointPositionActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_controllers_msgs/SingleJointPositionActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.pr2_controllers_msgs.singleJointPositionFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'pr2_controllers_msgs/SingleJointPositionActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
