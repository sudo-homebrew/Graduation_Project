function [data, info] = autoDockingActionFeedback
%AutoDockingActionFeedback gives an empty data for kobuki_msgs/AutoDockingActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'kobuki_msgs/AutoDockingActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.kobuki_msgs.autoDockingFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'kobuki_msgs/AutoDockingActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
