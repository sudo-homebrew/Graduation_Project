function [data, info] = exploreActionFeedback
%ExploreActionFeedback gives an empty data for nav2d_navigator/ExploreActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'nav2d_navigator/ExploreActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.nav2d_navigator.exploreFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'nav2d_navigator/ExploreActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'feedback.robot_pose';
info.MatPath{27} = 'feedback.robot_pose.x';
info.MatPath{28} = 'feedback.robot_pose.y';
info.MatPath{29} = 'feedback.robot_pose.theta';
info.MatPath{30} = 'feedback.target_pose';
info.MatPath{31} = 'feedback.target_pose.x';
info.MatPath{32} = 'feedback.target_pose.y';
info.MatPath{33} = 'feedback.target_pose.theta';
info.MatPath{34} = 'feedback.distance';
