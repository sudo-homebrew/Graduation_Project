...
%GetSyncInfo gives an empty data for multimaster_msgs_fkie/GetSyncInfoResponse

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'multimaster_msgs_fkie/GetSyncInfoResponse';
[data.Hosts, info.Hosts] = ros.internal.ros.messages.multimaster_msgs_fkie.syncMasterInfo;
info.Hosts.MLdataType = 'struct';
info.Hosts.MaxLen = NaN;
info.Hosts.MinLen = 0;
data.Hosts = data.Hosts([],1);
info.MessageType = 'multimaster_msgs_fkie/GetSyncInfoResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
