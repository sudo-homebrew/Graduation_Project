function [data, info] = cobPlaceFeedback
%CobPlaceFeedback gives an empty data for cob_pick_place_action/CobPlaceFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_pick_place_action/CobPlaceFeedback';
...
info.MessageType = 'cob_pick_place_action/CobPlaceFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
