function [data, info] = faceDetectorActionFeedback
%FaceDetectorActionFeedback gives an empty data for face_detector/FaceDetectorActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'face_detector/FaceDetectorActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.face_detector.faceDetectorFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'face_detector/FaceDetectorActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
