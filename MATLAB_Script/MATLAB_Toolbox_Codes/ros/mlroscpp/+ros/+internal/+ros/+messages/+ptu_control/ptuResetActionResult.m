function [data, info] = ptuResetActionResult
%PtuResetActionResult gives an empty data for ptu_control/PtuResetActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'ptu_control/PtuResetActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.ptu_control.ptuResetResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'ptu_control/PtuResetActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
