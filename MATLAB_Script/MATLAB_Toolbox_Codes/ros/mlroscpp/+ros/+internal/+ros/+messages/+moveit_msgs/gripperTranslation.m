...
%GripperTranslation gives an empty data for moveit_msgs/GripperTranslation

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'moveit_msgs/GripperTranslation';
...
info.MessageType = 'moveit_msgs/GripperTranslation';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
