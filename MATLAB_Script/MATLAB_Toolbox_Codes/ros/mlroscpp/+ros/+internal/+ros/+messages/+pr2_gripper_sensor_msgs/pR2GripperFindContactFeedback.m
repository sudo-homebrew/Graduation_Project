function [data, info] = pR2GripperFindContactFeedback
%PR2GripperFindContactFeedback gives an empty data for pr2_gripper_sensor_msgs/PR2GripperFindContactFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_gripper_sensor_msgs/PR2GripperFindContactFeedback';
...
info.MessageType = 'pr2_gripper_sensor_msgs/PR2GripperFindContactFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
