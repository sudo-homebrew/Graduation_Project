function [data, info] = pR2GripperGrabActionResult
%PR2GripperGrabActionResult gives an empty data for pr2_gripper_sensor_msgs/PR2GripperGrabActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_gripper_sensor_msgs/PR2GripperGrabActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.pr2_gripper_sensor_msgs.pR2GripperGrabResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'pr2_gripper_sensor_msgs/PR2GripperGrabActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
