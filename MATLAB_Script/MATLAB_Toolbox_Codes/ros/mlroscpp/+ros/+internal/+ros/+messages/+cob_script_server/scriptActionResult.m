function [data, info] = scriptActionResult
%ScriptActionResult gives an empty data for cob_script_server/ScriptActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_script_server/ScriptActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.cob_script_server.scriptResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'cob_script_server/ScriptActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
