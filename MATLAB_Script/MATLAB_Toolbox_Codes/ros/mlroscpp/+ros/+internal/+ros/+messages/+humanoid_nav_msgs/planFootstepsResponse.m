function [data, info] = planFootstepsResponse
%PlanFootsteps gives an empty data for humanoid_nav_msgs/PlanFootstepsResponse

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'humanoid_nav_msgs/PlanFootstepsResponse';
...
info.MessageType = 'humanoid_nav_msgs/PlanFootstepsResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
