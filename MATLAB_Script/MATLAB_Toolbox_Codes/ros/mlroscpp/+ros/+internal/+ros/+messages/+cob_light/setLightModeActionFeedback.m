function [data, info] = setLightModeActionFeedback
%SetLightModeActionFeedback gives an empty data for cob_light/SetLightModeActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_light/SetLightModeActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.cob_light.setLightModeFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'cob_light/SetLightModeActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'feedback.active_mode';
info.MatPath{27} = 'feedback.active_priority';
