function [data, info] = connectHubResponse
%ConnectHub gives an empty data for gateway_msgs/ConnectHubResponse

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'gateway_msgs/ConnectHubResponse';
...
info.MessageType = 'gateway_msgs/ConnectHubResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
