function [data, info] = acquireObjectImageActionResult
%AcquireObjectImageActionResult gives an empty data for cob_object_detection_msgs/AcquireObjectImageActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_object_detection_msgs/AcquireObjectImageActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.cob_object_detection_msgs.acquireObjectImageResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'cob_object_detection_msgs/AcquireObjectImageActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
