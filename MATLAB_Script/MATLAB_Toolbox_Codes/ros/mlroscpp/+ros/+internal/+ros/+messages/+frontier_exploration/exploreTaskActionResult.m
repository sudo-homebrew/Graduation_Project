function [data, info] = exploreTaskActionResult
%ExploreTaskActionResult gives an empty data for frontier_exploration/ExploreTaskActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'frontier_exploration/ExploreTaskActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.frontier_exploration.exploreTaskResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'frontier_exploration/ExploreTaskActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
