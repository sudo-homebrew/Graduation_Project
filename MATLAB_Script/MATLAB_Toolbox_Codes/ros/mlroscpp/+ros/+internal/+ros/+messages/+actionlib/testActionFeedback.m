function [data, info] = testActionFeedback
%TestActionFeedback gives an empty data for actionlib/TestActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'actionlib/TestActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.actionlib.testFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'actionlib/TestActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
