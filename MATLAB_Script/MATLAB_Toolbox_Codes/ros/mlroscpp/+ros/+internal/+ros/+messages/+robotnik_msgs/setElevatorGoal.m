function [data, info] = setElevatorGoal
%SetElevatorGoal gives an empty data for robotnik_msgs/SetElevatorGoal

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'robotnik_msgs/SetElevatorGoal';
[data.Action, info.Action] = ros.internal.ros.messages.robotnik_msgs.elevatorAction;
info.Action.MLdataType = 'struct';
info.MessageType = 'robotnik_msgs/SetElevatorGoal';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
