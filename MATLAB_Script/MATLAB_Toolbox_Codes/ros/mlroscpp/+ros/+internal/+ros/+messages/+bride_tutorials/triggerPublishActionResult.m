function [data, info] = triggerPublishActionResult
%TriggerPublishActionResult gives an empty data for bride_tutorials/TriggerPublishActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'bride_tutorials/TriggerPublishActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.bride_tutorials.triggerPublishResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'bride_tutorials/TriggerPublishActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
