function [data, info] = stopLightModeResponse
%StopLightMode gives an empty data for cob_light/StopLightModeResponse

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_light/StopLightModeResponse';
...
info.MessageType = 'cob_light/StopLightModeResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
