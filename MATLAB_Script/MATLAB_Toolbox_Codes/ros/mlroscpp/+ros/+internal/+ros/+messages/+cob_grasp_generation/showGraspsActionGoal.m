function [data, info] = showGraspsActionGoal
%ShowGraspsActionGoal gives an empty data for cob_grasp_generation/ShowGraspsActionGoal

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_grasp_generation/ShowGraspsActionGoal';
[data.Header, info.Header] = ros.internal.ros.messages.std_msgs.header;
info.Header.MLdataType = 'struct';
[data.GoalId, info.GoalId] = ros.internal.ros.messages.actionlib_msgs.goalID;
info.GoalId.MLdataType = 'struct';
[data.Goal, info.Goal] = ros.internal.ros.messages.cob_grasp_generation.showGraspsGoal;
info.Goal.MLdataType = 'struct';
info.MessageType = 'cob_grasp_generation/ShowGraspsActionGoal';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{17} = 'goal.sort_by_quality';
