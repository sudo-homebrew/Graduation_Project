function [data, info] = sayActionResult
%SayActionResult gives an empty data for cob_sound/SayActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_sound/SayActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.cob_sound.sayResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'cob_sound/SayActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
