...
%ExecFootstepsActionFeedback gives an empty data for jsk_footstep_msgs/ExecFootstepsActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'jsk_footstep_msgs/ExecFootstepsActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.jsk_footstep_msgs.execFootstepsFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'jsk_footstep_msgs/ExecFootstepsActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
