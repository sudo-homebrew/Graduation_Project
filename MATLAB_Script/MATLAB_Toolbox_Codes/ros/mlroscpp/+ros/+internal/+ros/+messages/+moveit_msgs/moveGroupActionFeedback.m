function [data, info] = moveGroupActionFeedback
%MoveGroupActionFeedback gives an empty data for moveit_msgs/MoveGroupActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'moveit_msgs/MoveGroupActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.moveit_msgs.moveGroupFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'moveit_msgs/MoveGroupActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
