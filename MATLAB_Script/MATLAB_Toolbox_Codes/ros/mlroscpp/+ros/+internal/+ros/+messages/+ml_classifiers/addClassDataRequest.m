function [data, info] = addClassDataRequest
%AddClassData gives an empty data for ml_classifiers/AddClassDataRequest

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'ml_classifiers/AddClassDataRequest';
...
info.MessageType = 'ml_classifiers/AddClassDataRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
