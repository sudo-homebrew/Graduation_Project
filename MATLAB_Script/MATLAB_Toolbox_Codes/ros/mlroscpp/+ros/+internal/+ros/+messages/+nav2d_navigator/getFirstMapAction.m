function [data, info] = getFirstMapAction
%GetFirstMapAction gives an empty data for nav2d_navigator/GetFirstMapAction

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'nav2d_navigator/GetFirstMapAction';
[data.ActionGoal, info.ActionGoal] = ros.internal.ros.messages.nav2d_navigator.getFirstMapActionGoal;
info.ActionGoal.MLdataType = 'struct';
[data.ActionResult, info.ActionResult] = ros.internal.ros.messages.nav2d_navigator.getFirstMapActionResult;
info.ActionResult.MLdataType = 'struct';
[data.ActionFeedback, info.ActionFeedback] = ros.internal.ros.messages.nav2d_navigator.getFirstMapActionFeedback;
info.ActionFeedback.MLdataType = 'struct';
info.MessageType = 'nav2d_navigator/GetFirstMapAction';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
