function [data, info] = setLightModeResponse
%SetLightMode gives an empty data for cob_light/SetLightModeResponse

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_light/SetLightModeResponse';
...
info.MessageType = 'cob_light/SetLightModeResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
