function [data, info] = autoDockingActionResult
%AutoDockingActionResult gives an empty data for kobuki_msgs/AutoDockingActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'kobuki_msgs/AutoDockingActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.kobuki_msgs.autoDockingResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'kobuki_msgs/AutoDockingActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
