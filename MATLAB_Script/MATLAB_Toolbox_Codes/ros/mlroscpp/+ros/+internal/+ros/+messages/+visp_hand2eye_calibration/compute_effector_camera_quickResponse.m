function [data, info] = compute_effector_camera_quickResponse
%compute_effector_camera_quick gives an empty data for visp_hand2eye_calibration/compute_effector_camera_quickResponse

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'visp_hand2eye_calibration/compute_effector_camera_quickResponse';
...
info.MessageType = 'visp_hand2eye_calibration/compute_effector_camera_quickResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
