function [data, info] = baseControllerState2
%BaseControllerState2 gives an empty data for pr2_mechanism_controllers/BaseControllerState2

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_mechanism_controllers/BaseControllerState2';
[data.Command, info.Command] = ros.internal.ros.messages.geometry_msgs.twist;
info.Command.MLdataType = 'struct';
[data.JointCommand, info.JointCommand] = ros.internal.ros.messages.ros.default_type('double',NaN);
[data.JointError, info.JointError] = ros.internal.ros.messages.ros.default_type('double',NaN);
...
info.MessageType = 'pr2_mechanism_controllers/BaseControllerState2';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{10} = 'joint_command';
info.MatPath{11} = 'joint_error';
info.MatPath{12} = 'joint_velocity_commanded';
info.MatPath{13} = 'joint_velocity_measured';
info.MatPath{14} = 'joint_effort_measured';
info.MatPath{15} = 'joint_effort_commanded';
info.MatPath{16} = 'joint_effort_error';
info.MatPath{17} = 'joint_names';
