function [data, info] = cobPickActionResult
%CobPickActionResult gives an empty data for cob_pick_place_action/CobPickActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_pick_place_action/CobPickActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.cob_pick_place_action.cobPickResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'cob_pick_place_action/CobPickActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
