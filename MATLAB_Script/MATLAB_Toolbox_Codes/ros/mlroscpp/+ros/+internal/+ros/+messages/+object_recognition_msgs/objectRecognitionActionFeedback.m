function [data, info] = objectRecognitionActionFeedback
%ObjectRecognitionActionFeedback gives an empty data for object_recognition_msgs/ObjectRecognitionActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'object_recognition_msgs/ObjectRecognitionActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.object_recognition_msgs.objectRecognitionFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'object_recognition_msgs/ObjectRecognitionActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
