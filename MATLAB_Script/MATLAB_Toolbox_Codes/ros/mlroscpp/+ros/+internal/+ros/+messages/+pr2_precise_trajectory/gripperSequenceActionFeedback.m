function [data, info] = gripperSequenceActionFeedback
%GripperSequenceActionFeedback gives an empty data for pr2_precise_trajectory/GripperSequenceActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_precise_trajectory/GripperSequenceActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.pr2_precise_trajectory.gripperSequenceFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'pr2_precise_trajectory/GripperSequenceActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
