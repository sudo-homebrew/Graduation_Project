function [data, info] = cobPickFeedback
%CobPickFeedback gives an empty data for cob_pick_place_action/CobPickFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_pick_place_action/CobPickFeedback';
...
info.MessageType = 'cob_pick_place_action/CobPickFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
