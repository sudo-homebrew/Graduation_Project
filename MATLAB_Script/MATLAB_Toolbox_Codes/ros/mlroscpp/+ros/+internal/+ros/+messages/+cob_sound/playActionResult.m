function [data, info] = playActionResult
%PlayActionResult gives an empty data for cob_sound/PlayActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_sound/PlayActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.cob_sound.playResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'cob_sound/PlayActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
