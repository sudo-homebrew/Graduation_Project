function [data, info] = getFirstMapActionResult
%GetFirstMapActionResult gives an empty data for nav2d_navigator/GetFirstMapActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'nav2d_navigator/GetFirstMapActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.nav2d_navigator.getFirstMapResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'nav2d_navigator/GetFirstMapActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
