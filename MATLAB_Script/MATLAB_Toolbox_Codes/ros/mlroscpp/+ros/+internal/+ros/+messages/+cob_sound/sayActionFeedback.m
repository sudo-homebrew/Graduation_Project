function [data, info] = sayActionFeedback
%SayActionFeedback gives an empty data for cob_sound/SayActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_sound/SayActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.cob_sound.sayFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'cob_sound/SayActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
