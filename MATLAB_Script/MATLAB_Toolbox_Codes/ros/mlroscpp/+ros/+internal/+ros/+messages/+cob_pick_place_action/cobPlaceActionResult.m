function [data, info] = cobPlaceActionResult
%CobPlaceActionResult gives an empty data for cob_pick_place_action/CobPlaceActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_pick_place_action/CobPlaceActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.cob_pick_place_action.cobPlaceResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'cob_pick_place_action/CobPlaceActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{27} = 'result.success.data';
info.MatPath{28} = 'result.cob_pick_error_string';
