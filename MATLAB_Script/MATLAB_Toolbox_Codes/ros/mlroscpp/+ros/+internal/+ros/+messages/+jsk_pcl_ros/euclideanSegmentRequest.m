...
%EuclideanSegment gives an empty data for jsk_pcl_ros/EuclideanSegmentRequest

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'jsk_pcl_ros/EuclideanSegmentRequest';
...
info.MessageType = 'jsk_pcl_ros/EuclideanSegmentRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
