...
%JointTrajectoryActionResult gives an empty data for control_msgs/JointTrajectoryActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'control_msgs/JointTrajectoryActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.control_msgs.jointTrajectoryResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'control_msgs/JointTrajectoryActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
