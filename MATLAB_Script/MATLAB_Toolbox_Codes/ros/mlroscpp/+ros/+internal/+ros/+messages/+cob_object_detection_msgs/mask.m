...
%Mask gives an empty data for cob_object_detection_msgs/Mask

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_object_detection_msgs/Mask';
[data.Roi, info.Roi] = ros.internal.ros.messages.cob_object_detection_msgs.rect;
info.Roi.MLdataType = 'struct';
[data.Mask_, info.Mask_] = ros.internal.ros.messages.sensor_msgs.image;
info.Mask_.MLdataType = 'struct';
info.MessageType = 'cob_object_detection_msgs/Mask';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
