function [data, info] = findFiducialActionFeedback
%FindFiducialActionFeedback gives an empty data for turtlebot_actions/FindFiducialActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'turtlebot_actions/FindFiducialActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.turtlebot_actions.findFiducialFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'turtlebot_actions/FindFiducialActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
