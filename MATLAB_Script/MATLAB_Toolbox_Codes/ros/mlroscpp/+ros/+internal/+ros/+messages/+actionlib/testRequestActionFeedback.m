function [data, info] = testRequestActionFeedback
%TestRequestActionFeedback gives an empty data for actionlib/TestRequestActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'actionlib/TestRequestActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.actionlib.testRequestFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'actionlib/TestRequestActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
