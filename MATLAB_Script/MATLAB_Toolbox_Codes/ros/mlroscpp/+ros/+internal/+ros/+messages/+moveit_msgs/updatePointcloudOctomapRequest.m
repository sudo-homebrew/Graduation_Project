function [data, info] = updatePointcloudOctomapRequest
%UpdatePointcloudOctomap gives an empty data for moveit_msgs/UpdatePointcloudOctomapRequest

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'moveit_msgs/UpdatePointcloudOctomapRequest';
[data.Cloud, info.Cloud] = ros.internal.ros.messages.sensor_msgs.pointCloud2;
info.Cloud.MLdataType = 'struct';
info.MessageType = 'moveit_msgs/UpdatePointcloudOctomapRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
