function [data, info] = lookAtActionFeedback
%LookAtActionFeedback gives an empty data for cob_lookat_action/LookAtActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_lookat_action/LookAtActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.cob_lookat_action.lookAtFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'cob_lookat_action/LookAtActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{27} = 'feedback.message';
