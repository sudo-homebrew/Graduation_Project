function [data, info] = localizeActionFeedback
%LocalizeActionFeedback gives an empty data for nav2d_navigator/LocalizeActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'nav2d_navigator/LocalizeActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.nav2d_navigator.localizeFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'nav2d_navigator/LocalizeActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
