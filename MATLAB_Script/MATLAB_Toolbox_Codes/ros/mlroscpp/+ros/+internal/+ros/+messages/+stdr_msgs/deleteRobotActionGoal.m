function [data, info] = deleteRobotActionGoal
%DeleteRobotActionGoal gives an empty data for stdr_msgs/DeleteRobotActionGoal

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'stdr_msgs/DeleteRobotActionGoal';
[data.Header, info.Header] = ros.internal.ros.messages.std_msgs.header;
info.Header.MLdataType = 'struct';
[data.GoalId, info.GoalId] = ros.internal.ros.messages.actionlib_msgs.goalID;
info.GoalId.MLdataType = 'struct';
[data.Goal, info.Goal] = ros.internal.ros.messages.stdr_msgs.deleteRobotGoal;
info.Goal.MLdataType = 'struct';
info.MessageType = 'stdr_msgs/DeleteRobotActionGoal';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
