function [data, info] = poseTwistStamped
%PoseTwistStamped gives an empty data for r2_msgs/PoseTwistStamped

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'r2_msgs/PoseTwistStamped';
...
info.MessageType = 'r2_msgs/PoseTwistStamped';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
