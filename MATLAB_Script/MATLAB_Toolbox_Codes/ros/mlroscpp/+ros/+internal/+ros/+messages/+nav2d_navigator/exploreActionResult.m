function [data, info] = exploreActionResult
%ExploreActionResult gives an empty data for nav2d_navigator/ExploreActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'nav2d_navigator/ExploreActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.nav2d_navigator.exploreResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'nav2d_navigator/ExploreActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
