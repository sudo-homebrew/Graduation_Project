function [data, info] = moveToPosition2DActionResult
%MoveToPosition2DActionResult gives an empty data for nav2d_navigator/MoveToPosition2DActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'nav2d_navigator/MoveToPosition2DActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.nav2d_navigator.moveToPosition2DResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'nav2d_navigator/MoveToPosition2DActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'result.final_pose';
info.MatPath{27} = 'result.final_pose.x';
info.MatPath{28} = 'result.final_pose.y';
info.MatPath{29} = 'result.final_pose.theta';
info.MatPath{30} = 'result.final_distance';
