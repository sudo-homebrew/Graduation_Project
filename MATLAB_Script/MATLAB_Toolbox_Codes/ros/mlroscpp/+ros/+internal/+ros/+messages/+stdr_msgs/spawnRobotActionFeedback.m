function [data, info] = spawnRobotActionFeedback
%SpawnRobotActionFeedback gives an empty data for stdr_msgs/SpawnRobotActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'stdr_msgs/SpawnRobotActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.stdr_msgs.spawnRobotFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'stdr_msgs/SpawnRobotActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
