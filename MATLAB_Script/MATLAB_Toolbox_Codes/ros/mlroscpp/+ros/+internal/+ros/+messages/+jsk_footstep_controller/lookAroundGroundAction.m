function [data, info] = lookAroundGroundAction
%LookAroundGroundAction gives an empty data for jsk_footstep_controller/LookAroundGroundAction

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'jsk_footstep_controller/LookAroundGroundAction';
[data.ActionGoal, info.ActionGoal] = ros.internal.ros.messages.jsk_footstep_controller.lookAroundGroundActionGoal;
info.ActionGoal.MLdataType = 'struct';
[data.ActionResult, info.ActionResult] = ros.internal.ros.messages.jsk_footstep_controller.lookAroundGroundActionResult;
info.ActionResult.MLdataType = 'struct';
[data.ActionFeedback, info.ActionFeedback] = ros.internal.ros.messages.jsk_footstep_controller.lookAroundGroundActionFeedback;
info.ActionFeedback.MLdataType = 'struct';
info.MessageType = 'jsk_footstep_controller/LookAroundGroundAction';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
