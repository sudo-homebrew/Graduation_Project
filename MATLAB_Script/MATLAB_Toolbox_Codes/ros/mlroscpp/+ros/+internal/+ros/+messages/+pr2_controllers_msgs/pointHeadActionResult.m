function [data, info] = pointHeadActionResult
%PointHeadActionResult gives an empty data for pr2_controllers_msgs/PointHeadActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_controllers_msgs/PointHeadActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.pr2_controllers_msgs.pointHeadResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'pr2_controllers_msgs/PointHeadActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
