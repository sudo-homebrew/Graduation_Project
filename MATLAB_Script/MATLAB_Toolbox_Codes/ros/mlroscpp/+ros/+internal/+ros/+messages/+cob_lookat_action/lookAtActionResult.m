function [data, info] = lookAtActionResult
%LookAtActionResult gives an empty data for cob_lookat_action/LookAtActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_lookat_action/LookAtActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.cob_lookat_action.lookAtResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'cob_lookat_action/LookAtActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{27} = 'result.message';
