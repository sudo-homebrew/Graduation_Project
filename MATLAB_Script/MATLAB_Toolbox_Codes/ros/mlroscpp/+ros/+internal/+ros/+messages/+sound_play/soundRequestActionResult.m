function [data, info] = soundRequestActionResult
%SoundRequestActionResult gives an empty data for sound_play/SoundRequestActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'sound_play/SoundRequestActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.sound_play.soundRequestResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'sound_play/SoundRequestActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'result.playing';
info.MatPath{27} = 'result.stamp';
info.MatPath{28} = 'result.stamp.sec';
info.MatPath{29} = 'result.stamp.nsec';
