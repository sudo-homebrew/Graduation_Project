...
%SyncMasterInfo gives an empty data for fkie_multimaster_msgs/SyncMasterInfo

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'fkie_multimaster_msgs/SyncMasterInfo';
