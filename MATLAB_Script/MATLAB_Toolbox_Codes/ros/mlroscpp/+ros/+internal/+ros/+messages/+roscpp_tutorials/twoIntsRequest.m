...
%TwoInts gives an empty data for roscpp_tutorials/TwoIntsRequest

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'roscpp_tutorials/TwoIntsRequest';
...
info.MessageType = 'roscpp_tutorials/TwoIntsRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
