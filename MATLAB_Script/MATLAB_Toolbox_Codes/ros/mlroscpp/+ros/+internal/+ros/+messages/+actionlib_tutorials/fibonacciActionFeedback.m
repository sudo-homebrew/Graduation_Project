function [data, info] = fibonacciActionFeedback
%FibonacciActionFeedback gives an empty data for actionlib_tutorials/FibonacciActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'actionlib_tutorials/FibonacciActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.actionlib_tutorials.fibonacciFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'actionlib_tutorials/FibonacciActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'feedback.sequence';
