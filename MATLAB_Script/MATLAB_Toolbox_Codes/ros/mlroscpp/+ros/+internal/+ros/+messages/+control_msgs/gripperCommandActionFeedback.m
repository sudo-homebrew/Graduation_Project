function [data, info] = gripperCommandActionFeedback
%GripperCommandActionFeedback gives an empty data for control_msgs/GripperCommandActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'control_msgs/GripperCommandActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.control_msgs.gripperCommandFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'control_msgs/GripperCommandActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
