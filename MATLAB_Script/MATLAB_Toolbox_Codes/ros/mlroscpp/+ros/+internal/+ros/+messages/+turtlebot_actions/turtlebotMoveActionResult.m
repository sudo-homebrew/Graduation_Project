function [data, info] = turtlebotMoveActionResult
%TurtlebotMoveActionResult gives an empty data for turtlebot_actions/TurtlebotMoveActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'turtlebot_actions/TurtlebotMoveActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.turtlebot_actions.turtlebotMoveResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'turtlebot_actions/TurtlebotMoveActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'result.turn_distance';
info.MatPath{27} = 'result.forward_distance';
