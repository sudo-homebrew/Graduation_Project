function [data, info] = showGraspsActionResult
%ShowGraspsActionResult gives an empty data for cob_grasp_generation/ShowGraspsActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_grasp_generation/ShowGraspsActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.cob_grasp_generation.showGraspsResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'cob_grasp_generation/ShowGraspsActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
