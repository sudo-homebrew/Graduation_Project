function [data, info] = setLightModeActionResult
%SetLightModeActionResult gives an empty data for cob_light/SetLightModeActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_light/SetLightModeActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.cob_light.setLightModeResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'cob_light/SetLightModeActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'result.active_mode';
info.MatPath{27} = 'result.active_priority';
info.MatPath{28} = 'result.track_id';
