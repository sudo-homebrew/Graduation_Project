function [data, info] = setPointCloud2Request
%SetPointCloud2 gives an empty data for jsk_pcl_ros/SetPointCloud2Request

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'jsk_pcl_ros/SetPointCloud2Request';
[data.Cloud, info.Cloud] = ros.internal.ros.messages.sensor_msgs.pointCloud2;
info.Cloud.MLdataType = 'struct';
info.MessageType = 'jsk_pcl_ros/SetPointCloud2Request';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
