function [data, info] = composeTrajectoryResponse
%ComposeTrajectory gives an empty data for cob_script_server/ComposeTrajectoryResponse

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_script_server/ComposeTrajectoryResponse';
...
info.MessageType = 'cob_script_server/ComposeTrajectoryResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
