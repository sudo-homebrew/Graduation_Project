function [data, info] = twoIntsActionResult
%TwoIntsActionResult gives an empty data for actionlib/TwoIntsActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'actionlib/TwoIntsActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.actionlib.twoIntsResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'actionlib/TwoIntsActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
