function [data, info] = ptuResetActionFeedback
%PtuResetActionFeedback gives an empty data for ptu_control/PtuResetActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'ptu_control/PtuResetActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.ptu_control.ptuResetFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'ptu_control/PtuResetActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
