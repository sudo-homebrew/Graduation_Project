...
%TestActionResult gives an empty data for asmach_tutorials/TestActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'asmach_tutorials/TestActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.asmach_tutorials.testResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'asmach_tutorials/TestActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
