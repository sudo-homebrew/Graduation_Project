function [data, info] = thermalSensorMsg
%ThermalSensorMsg gives an empty data for stdr_msgs/ThermalSensorMsg

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'stdr_msgs/ThermalSensorMsg';
...
info.MessageType = 'stdr_msgs/ThermalSensorMsg';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
