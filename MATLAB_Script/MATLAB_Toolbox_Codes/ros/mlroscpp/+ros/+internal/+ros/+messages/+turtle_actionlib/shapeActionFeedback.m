function [data, info] = shapeActionFeedback
%ShapeActionFeedback gives an empty data for turtle_actionlib/ShapeActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'turtle_actionlib/ShapeActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.turtle_actionlib.shapeFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'turtle_actionlib/ShapeActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
