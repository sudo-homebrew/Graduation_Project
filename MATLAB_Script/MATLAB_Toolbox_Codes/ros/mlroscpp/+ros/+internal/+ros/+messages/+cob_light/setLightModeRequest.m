function [data, info] = setLightModeRequest
%SetLightMode gives an empty data for cob_light/SetLightModeRequest

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_light/SetLightModeRequest';
[data.Mode, info.Mode] = ros.internal.ros.messages.cob_light.lightMode;
info.Mode.MLdataType = 'struct';
info.MessageType = 'cob_light/SetLightModeRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
