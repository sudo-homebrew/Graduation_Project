function [data, info] = acquireObjectImageActionFeedback
%AcquireObjectImageActionFeedback gives an empty data for cob_object_detection_msgs/AcquireObjectImageActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_object_detection_msgs/AcquireObjectImageActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.cob_object_detection_msgs.acquireObjectImageFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'cob_object_detection_msgs/AcquireObjectImageActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'feedback.percent_complete';
