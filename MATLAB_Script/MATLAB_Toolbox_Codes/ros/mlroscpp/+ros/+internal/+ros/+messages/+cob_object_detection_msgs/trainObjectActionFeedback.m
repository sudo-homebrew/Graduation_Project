function [data, info] = trainObjectActionFeedback
%TrainObjectActionFeedback gives an empty data for cob_object_detection_msgs/TrainObjectActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_object_detection_msgs/TrainObjectActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.cob_object_detection_msgs.trainObjectFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'cob_object_detection_msgs/TrainObjectActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
