function [data, info] = serviceResponseDetailsResponse
%ServiceResponseDetails gives an empty data for rosapi/ServiceResponseDetailsResponse

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'rosapi/ServiceResponseDetailsResponse';
...
info.MessageType = 'rosapi/ServiceResponseDetailsResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
