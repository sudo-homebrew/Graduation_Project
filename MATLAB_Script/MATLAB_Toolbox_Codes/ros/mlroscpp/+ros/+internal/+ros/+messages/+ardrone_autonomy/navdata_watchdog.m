function [data, info] = navdata_watchdog
%navdata_watchdog gives an empty data for ardrone_autonomy/navdata_watchdog

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'ardrone_autonomy/navdata_watchdog';
...
info.MessageType = 'ardrone_autonomy/navdata_watchdog';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
