...
%PositionMeasurementArray gives an empty data for people_msgs/PositionMeasurementArray

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'people_msgs/PositionMeasurementArray';
[data.Header, info.Header] = ros.internal.ros.messages.std_msgs.header;
info.Header.MLdataType = 'struct';
[data.People, info.People] = ros.internal.ros.messages.people_msgs.positionMeasurement;
...
info.MessageType = 'people_msgs/PositionMeasurementArray';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{20} = 'people.reliability';
info.MatPath{21} = 'people.covariance';
info.MatPath{22} = 'people.initialization';
info.MatPath{23} = 'cooccurrence';
