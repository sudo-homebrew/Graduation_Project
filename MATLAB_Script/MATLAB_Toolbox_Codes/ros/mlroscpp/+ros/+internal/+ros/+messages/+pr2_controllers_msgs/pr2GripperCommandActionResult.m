function [data, info] = pr2GripperCommandActionResult
%Pr2GripperCommandActionResult gives an empty data for pr2_controllers_msgs/Pr2GripperCommandActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_controllers_msgs/Pr2GripperCommandActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.pr2_controllers_msgs.pr2GripperCommandResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'pr2_controllers_msgs/Pr2GripperCommandActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'result.position';
info.MatPath{27} = 'result.effort';
info.MatPath{28} = 'result.stalled';
info.MatPath{29} = 'result.reached_goal';
