...
%JointTrajectoryAction gives an empty data for pr2_controllers_msgs/JointTrajectoryAction

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_controllers_msgs/JointTrajectoryAction';
[data.ActionGoal, info.ActionGoal] = ros.internal.ros.messages.pr2_controllers_msgs.jointTrajectoryActionGoal;
info.ActionGoal.MLdataType = 'struct';
[data.ActionResult, info.ActionResult] = ros.internal.ros.messages.pr2_controllers_msgs.jointTrajectoryActionResult;
info.ActionResult.MLdataType = 'struct';
[data.ActionFeedback, info.ActionFeedback] = ros.internal.ros.messages.pr2_controllers_msgs.jointTrajectoryActionFeedback;
info.ActionFeedback.MLdataType = 'struct';
info.MessageType = 'pr2_controllers_msgs/JointTrajectoryAction';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
