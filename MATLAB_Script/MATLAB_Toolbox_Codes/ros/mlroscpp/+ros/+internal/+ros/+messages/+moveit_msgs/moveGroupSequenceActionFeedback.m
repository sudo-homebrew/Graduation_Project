function [data, info] = moveGroupSequenceActionFeedback
%MoveGroupSequenceActionFeedback gives an empty data for moveit_msgs/MoveGroupSequenceActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'moveit_msgs/MoveGroupSequenceActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.moveit_msgs.moveGroupSequenceFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'moveit_msgs/MoveGroupSequenceActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
