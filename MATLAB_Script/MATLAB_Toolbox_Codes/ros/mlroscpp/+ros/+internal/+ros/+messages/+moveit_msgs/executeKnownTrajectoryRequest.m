function [data, info] = executeKnownTrajectoryRequest
%ExecuteKnownTrajectory gives an empty data for moveit_msgs/ExecuteKnownTrajectoryRequest

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'moveit_msgs/ExecuteKnownTrajectoryRequest';
[data.Trajectory, info.Trajectory] = ros.internal.ros.messages.moveit_msgs.robotTrajectory;
info.Trajectory.MLdataType = 'struct';
[data.WaitForExecution, info.WaitForExecution] = ros.internal.ros.messages.ros.default_type('logical',1);
info.MessageType = 'moveit_msgs/ExecuteKnownTrajectoryRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{58} = 'wait_for_execution';
