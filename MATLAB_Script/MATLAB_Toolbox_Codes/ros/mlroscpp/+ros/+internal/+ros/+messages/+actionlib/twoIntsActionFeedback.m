function [data, info] = twoIntsActionFeedback
%TwoIntsActionFeedback gives an empty data for actionlib/TwoIntsActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'actionlib/TwoIntsActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.actionlib.twoIntsFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'actionlib/TwoIntsActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
