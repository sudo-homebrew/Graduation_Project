function [data, info] = moveSequenceActionResult
%MoveSequenceActionResult gives an empty data for pr2_precise_trajectory/MoveSequenceActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_precise_trajectory/MoveSequenceActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.pr2_precise_trajectory.moveSequenceResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'pr2_precise_trajectory/MoveSequenceActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
