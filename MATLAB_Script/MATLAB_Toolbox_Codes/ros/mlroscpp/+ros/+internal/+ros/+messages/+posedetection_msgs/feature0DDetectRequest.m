function [data, info] = feature0DDetectRequest
%Feature0DDetect gives an empty data for posedetection_msgs/Feature0DDetectRequest

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'posedetection_msgs/Feature0DDetectRequest';
[data.Image, info.Image] = ros.internal.ros.messages.sensor_msgs.image;
info.Image.MLdataType = 'struct';
info.MessageType = 'posedetection_msgs/Feature0DDetectRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
