...
%GraspPlanningActionFeedback gives an empty data for grasping_msgs/GraspPlanningActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'grasping_msgs/GraspPlanningActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.grasping_msgs.graspPlanningFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'grasping_msgs/GraspPlanningActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
