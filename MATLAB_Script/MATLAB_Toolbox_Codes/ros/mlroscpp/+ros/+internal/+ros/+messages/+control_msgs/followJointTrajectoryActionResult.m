function [data, info] = followJointTrajectoryActionResult
%FollowJointTrajectoryActionResult gives an empty data for control_msgs/FollowJointTrajectoryActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'control_msgs/FollowJointTrajectoryActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.control_msgs.followJointTrajectoryResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'control_msgs/FollowJointTrajectoryActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{27} = 'result.SUCCESSFUL';
info.MatPath{28} = 'result.INVALID_GOAL';
info.MatPath{29} = 'result.INVALID_JOINTS';
info.MatPath{30} = 'result.OLD_HEADER_TIMESTAMP';
info.MatPath{31} = 'result.PATH_TOLERANCE_VIOLATED';
info.MatPath{32} = 'result.GOAL_TOLERANCE_VIOLATED';
info.MatPath{33} = 'result.error_string';
