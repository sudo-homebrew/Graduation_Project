...
%ConfigActionFeedback gives an empty data for joint_states_settler/ConfigActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'joint_states_settler/ConfigActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.joint_states_settler.configFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'joint_states_settler/ConfigActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
