function [data, info] = turtlebotMoveActionFeedback
%TurtlebotMoveActionFeedback gives an empty data for turtlebot_actions/TurtlebotMoveActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'turtlebot_actions/TurtlebotMoveActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.turtlebot_actions.turtlebotMoveFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'turtlebot_actions/TurtlebotMoveActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'feedback.turn_distance';
info.MatPath{27} = 'feedback.forward_distance';
