function [data, info] = restartControllerRequest
%RestartController gives an empty data for dynamixel_controllers/RestartControllerRequest

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'dynamixel_controllers/RestartControllerRequest';
...
info.MessageType = 'dynamixel_controllers/RestartControllerRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
