function [data, info] = gripperCommandActionResult
%GripperCommandActionResult gives an empty data for control_msgs/GripperCommandActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'control_msgs/GripperCommandActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.control_msgs.gripperCommandResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'control_msgs/GripperCommandActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
