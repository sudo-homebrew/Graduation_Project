function [data, info] = exploreActionGoal
%ExploreActionGoal gives an empty data for nav2d_navigator/ExploreActionGoal

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'nav2d_navigator/ExploreActionGoal';
[data.Header, info.Header] = ros.internal.ros.messages.std_msgs.header;
info.Header.MLdataType = 'struct';
[data.GoalId, info.GoalId] = ros.internal.ros.messages.actionlib_msgs.goalID;
info.GoalId.MLdataType = 'struct';
[data.Goal, info.Goal] = ros.internal.ros.messages.nav2d_navigator.exploreGoal;
info.Goal.MLdataType = 'struct';
info.MessageType = 'nav2d_navigator/ExploreActionGoal';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
