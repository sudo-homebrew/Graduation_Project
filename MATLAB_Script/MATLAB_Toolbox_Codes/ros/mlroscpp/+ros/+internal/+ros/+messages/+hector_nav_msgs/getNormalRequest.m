function [data, info] = getNormalRequest
%GetNormal gives an empty data for hector_nav_msgs/GetNormalRequest

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'hector_nav_msgs/GetNormalRequest';
[data.Point, info.Point] = ros.internal.ros.messages.geometry_msgs.pointStamped;
info.Point.MLdataType = 'struct';
info.MessageType = 'hector_nav_msgs/GetNormalRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
