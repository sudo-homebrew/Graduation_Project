function [data, info] = ptuSetVelActionResult
%PtuSetVelActionResult gives an empty data for ptu_control/PtuSetVelActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'ptu_control/PtuSetVelActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.ptu_control.ptuSetVelResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'ptu_control/PtuSetVelActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'result.pan';
info.MatPath{27} = 'result.tilt';
