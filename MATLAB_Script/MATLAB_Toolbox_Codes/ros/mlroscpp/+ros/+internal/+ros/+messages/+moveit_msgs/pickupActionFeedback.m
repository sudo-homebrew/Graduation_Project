function [data, info] = pickupActionFeedback
%PickupActionFeedback gives an empty data for moveit_msgs/PickupActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'moveit_msgs/PickupActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.moveit_msgs.pickupFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'moveit_msgs/PickupActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
