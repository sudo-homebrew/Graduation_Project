function [data, info] = reconfigureResponse
%Reconfigure gives an empty data for dynamic_reconfigure/ReconfigureResponse

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'dynamic_reconfigure/ReconfigureResponse';
[data.Config, info.Config] = ros.internal.ros.messages.dynamic_reconfigure.config;
info.Config.MLdataType = 'struct';
info.MessageType = 'dynamic_reconfigure/ReconfigureResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
