function [data, info] = getSnapshotFeedback
%GetSnapshotFeedback gives an empty data for pr2_tilt_laser_interface/GetSnapshotFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_tilt_laser_interface/GetSnapshotFeedback';
[data.Cloud, info.Cloud] = ros.internal.ros.messages.sensor_msgs.pointCloud2;
info.Cloud.MLdataType = 'struct';
info.MessageType = 'pr2_tilt_laser_interface/GetSnapshotFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
