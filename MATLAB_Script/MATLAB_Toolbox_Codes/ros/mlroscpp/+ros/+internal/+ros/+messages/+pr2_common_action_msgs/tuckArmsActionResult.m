function [data, info] = tuckArmsActionResult
%TuckArmsActionResult gives an empty data for pr2_common_action_msgs/TuckArmsActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_common_action_msgs/TuckArmsActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.pr2_common_action_msgs.tuckArmsResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'pr2_common_action_msgs/TuckArmsActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'result.tuck_left';
info.MatPath{27} = 'result.tuck_right';
