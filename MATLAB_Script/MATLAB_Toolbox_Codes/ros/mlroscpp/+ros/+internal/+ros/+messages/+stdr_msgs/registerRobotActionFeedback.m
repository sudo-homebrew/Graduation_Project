function [data, info] = registerRobotActionFeedback
%RegisterRobotActionFeedback gives an empty data for stdr_msgs/RegisterRobotActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'stdr_msgs/RegisterRobotActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.stdr_msgs.registerRobotFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'stdr_msgs/RegisterRobotActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
