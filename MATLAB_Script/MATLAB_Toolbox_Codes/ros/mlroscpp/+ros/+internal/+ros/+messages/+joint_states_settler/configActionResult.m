...
%ConfigActionResult gives an empty data for joint_states_settler/ConfigActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'joint_states_settler/ConfigActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.joint_states_settler.configResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'joint_states_settler/ConfigActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
