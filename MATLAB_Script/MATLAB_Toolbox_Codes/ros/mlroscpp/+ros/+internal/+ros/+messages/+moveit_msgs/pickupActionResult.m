function [data, info] = pickupActionResult
%PickupActionResult gives an empty data for moveit_msgs/PickupActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'moveit_msgs/PickupActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.moveit_msgs.pickupResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'moveit_msgs/PickupActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
info.MinLen = 1;
info.MatPath = cell(1,367);
...
info.MatPath{271} = 'result.grasp';
info.MatPath{272} = 'result.grasp.id';
info.MatPath{273} = 'result.grasp.pre_grasp_posture';
info.MatPath{274} = 'result.grasp.pre_grasp_posture.header';
info.MatPath{275} = 'result.grasp.pre_grasp_posture.header.seq';
info.MatPath{276} = 'result.grasp.pre_grasp_posture.header.stamp';
info.MatPath{277} = 'result.grasp.pre_grasp_posture.header.stamp.sec';
info.MatPath{278} = 'result.grasp.pre_grasp_posture.header.stamp.nsec';
info.MatPath{279} = 'result.grasp.pre_grasp_posture.header.frame_id';
info.MatPath{280} = 'result.grasp.pre_grasp_posture.joint_names';
info.MatPath{281} = 'result.grasp.pre_grasp_posture.points';
info.MatPath{282} = 'result.grasp.pre_grasp_posture.points.positions';
info.MatPath{283} = 'result.grasp.pre_grasp_posture.points.velocities';
info.MatPath{284} = 'result.grasp.pre_grasp_posture.points.accelerations';
info.MatPath{285} = 'result.grasp.pre_grasp_posture.points.effort';
info.MatPath{286} = 'result.grasp.pre_grasp_posture.points.time_from_start';
info.MatPath{287} = 'result.grasp.pre_grasp_posture.points.time_from_start.sec';
info.MatPath{288} = 'result.grasp.pre_grasp_posture.points.time_from_start.nsec';
info.MatPath{289} = 'result.grasp.grasp_posture';
info.MatPath{290} = 'result.grasp.grasp_posture.header';
info.MatPath{291} = 'result.grasp.grasp_posture.header.seq';
info.MatPath{292} = 'result.grasp.grasp_posture.header.stamp';
info.MatPath{293} = 'result.grasp.grasp_posture.header.stamp.sec';
info.MatPath{294} = 'result.grasp.grasp_posture.header.stamp.nsec';
info.MatPath{295} = 'result.grasp.grasp_posture.header.frame_id';
info.MatPath{296} = 'result.grasp.grasp_posture.joint_names';
info.MatPath{297} = 'result.grasp.grasp_posture.points';
info.MatPath{298} = 'result.grasp.grasp_posture.points.positions';
info.MatPath{299} = 'result.grasp.grasp_posture.points.velocities';
info.MatPath{300} = 'result.grasp.grasp_posture.points.accelerations';
info.MatPath{301} = 'result.grasp.grasp_posture.points.effort';
info.MatPath{302} = 'result.grasp.grasp_posture.points.time_from_start';
info.MatPath{303} = 'result.grasp.grasp_posture.points.time_from_start.sec';
info.MatPath{304} = 'result.grasp.grasp_posture.points.time_from_start.nsec';
info.MatPath{305} = 'result.grasp.grasp_pose';
info.MatPath{306} = 'result.grasp.grasp_pose.header';
info.MatPath{307} = 'result.grasp.grasp_pose.header.seq';
info.MatPath{308} = 'result.grasp.grasp_pose.header.stamp';
info.MatPath{309} = 'result.grasp.grasp_pose.header.stamp.sec';
info.MatPath{310} = 'result.grasp.grasp_pose.header.stamp.nsec';
info.MatPath{311} = 'result.grasp.grasp_pose.header.frame_id';
info.MatPath{312} = 'result.grasp.grasp_pose.pose';
info.MatPath{313} = 'result.grasp.grasp_pose.pose.position';
info.MatPath{314} = 'result.grasp.grasp_pose.pose.position.x';
info.MatPath{315} = 'result.grasp.grasp_pose.pose.position.y';
info.MatPath{316} = 'result.grasp.grasp_pose.pose.position.z';
info.MatPath{317} = 'result.grasp.grasp_pose.pose.orientation';
info.MatPath{318} = 'result.grasp.grasp_pose.pose.orientation.x';
info.MatPath{319} = 'result.grasp.grasp_pose.pose.orientation.y';
info.MatPath{320} = 'result.grasp.grasp_pose.pose.orientation.z';
info.MatPath{321} = 'result.grasp.grasp_pose.pose.orientation.w';
info.MatPath{322} = 'result.grasp.grasp_quality';
info.MatPath{323} = 'result.grasp.pre_grasp_approach';
info.MatPath{324} = 'result.grasp.pre_grasp_approach.direction';
info.MatPath{325} = 'result.grasp.pre_grasp_approach.direction.header';
info.MatPath{326} = 'result.grasp.pre_grasp_approach.direction.header.seq';
info.MatPath{327} = 'result.grasp.pre_grasp_approach.direction.header.stamp';
info.MatPath{328} = 'result.grasp.pre_grasp_approach.direction.header.stamp.sec';
info.MatPath{329} = 'result.grasp.pre_grasp_approach.direction.header.stamp.nsec';
info.MatPath{330} = 'result.grasp.pre_grasp_approach.direction.header.frame_id';
info.MatPath{331} = 'result.grasp.pre_grasp_approach.direction.vector';
info.MatPath{332} = 'result.grasp.pre_grasp_approach.direction.vector.x';
info.MatPath{333} = 'result.grasp.pre_grasp_approach.direction.vector.y';
info.MatPath{334} = 'result.grasp.pre_grasp_approach.direction.vector.z';
info.MatPath{335} = 'result.grasp.pre_grasp_approach.desired_distance';
info.MatPath{336} = 'result.grasp.pre_grasp_approach.min_distance';
info.MatPath{337} = 'result.grasp.post_grasp_retreat';
info.MatPath{338} = 'result.grasp.post_grasp_retreat.direction';
info.MatPath{339} = 'result.grasp.post_grasp_retreat.direction.header';
info.MatPath{340} = 'result.grasp.post_grasp_retreat.direction.header.seq';
info.MatPath{341} = 'result.grasp.post_grasp_retreat.direction.header.stamp';
info.MatPath{342} = 'result.grasp.post_grasp_retreat.direction.header.stamp.sec';
info.MatPath{343} = 'result.grasp.post_grasp_retreat.direction.header.stamp.nsec';
info.MatPath{344} = 'result.grasp.post_grasp_retreat.direction.header.frame_id';
info.MatPath{345} = 'result.grasp.post_grasp_retreat.direction.vector';
info.MatPath{346} = 'result.grasp.post_grasp_retreat.direction.vector.x';
info.MatPath{347} = 'result.grasp.post_grasp_retreat.direction.vector.y';
info.MatPath{348} = 'result.grasp.post_grasp_retreat.direction.vector.z';
info.MatPath{349} = 'result.grasp.post_grasp_retreat.desired_distance';
info.MatPath{350} = 'result.grasp.post_grasp_retreat.min_distance';
info.MatPath{351} = 'result.grasp.post_place_retreat';
info.MatPath{352} = 'result.grasp.post_place_retreat.direction';
info.MatPath{353} = 'result.grasp.post_place_retreat.direction.header';
info.MatPath{354} = 'result.grasp.post_place_retreat.direction.header.seq';
info.MatPath{355} = 'result.grasp.post_place_retreat.direction.header.stamp';
info.MatPath{356} = 'result.grasp.post_place_retreat.direction.header.stamp.sec';
info.MatPath{357} = 'result.grasp.post_place_retreat.direction.header.stamp.nsec';
info.MatPath{358} = 'result.grasp.post_place_retreat.direction.header.frame_id';
info.MatPath{359} = 'result.grasp.post_place_retreat.direction.vector';
info.MatPath{360} = 'result.grasp.post_place_retreat.direction.vector.x';
info.MatPath{361} = 'result.grasp.post_place_retreat.direction.vector.y';
info.MatPath{362} = 'result.grasp.post_place_retreat.direction.vector.z';
info.MatPath{363} = 'result.grasp.post_place_retreat.desired_distance';
info.MatPath{364} = 'result.grasp.post_place_retreat.min_distance';
info.MatPath{365} = 'result.grasp.max_contact_force';
info.MatPath{366} = 'result.grasp.allowed_touch_objects';
info.MatPath{367} = 'result.planning_time';
