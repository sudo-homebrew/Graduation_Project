function [data, info] = testActionResult
%TestActionResult gives an empty data for actionlib/TestActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'actionlib/TestActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.actionlib.testResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'actionlib/TestActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
