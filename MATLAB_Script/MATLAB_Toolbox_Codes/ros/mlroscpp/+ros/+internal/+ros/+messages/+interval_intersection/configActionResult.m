function [data, info] = configActionResult
%ConfigActionResult gives an empty data for interval_intersection/ConfigActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'interval_intersection/ConfigActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.interval_intersection.configResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'interval_intersection/ConfigActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
