function [data, info] = moveSequenceActionFeedback
%MoveSequenceActionFeedback gives an empty data for pr2_precise_trajectory/MoveSequenceActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_precise_trajectory/MoveSequenceActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.pr2_precise_trajectory.moveSequenceFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'pr2_precise_trajectory/MoveSequenceActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'feedback.pose_index';
info.MatPath{27} = 'feedback.percent_complete';
