function [data, info] = ptuResetAction
%PtuResetAction gives an empty data for ptu_control/PtuResetAction

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'ptu_control/PtuResetAction';
[data.ActionGoal, info.ActionGoal] = ros.internal.ros.messages.ptu_control.ptuResetActionGoal;
info.ActionGoal.MLdataType = 'struct';
[data.ActionResult, info.ActionResult] = ros.internal.ros.messages.ptu_control.ptuResetActionResult;
info.ActionResult.MLdataType = 'struct';
[data.ActionFeedback, info.ActionFeedback] = ros.internal.ros.messages.ptu_control.ptuResetActionFeedback;
info.ActionFeedback.MLdataType = 'struct';
info.MessageType = 'ptu_control/PtuResetAction';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
