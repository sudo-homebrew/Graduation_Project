...
%SwitchController gives an empty data for pr2_mechanism_msgs/SwitchControllerRequest

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_mechanism_msgs/SwitchControllerRequest';
...
info.MessageType = 'pr2_mechanism_msgs/SwitchControllerRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
