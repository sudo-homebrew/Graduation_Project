function [data, info] = pR2GripperReleaseData
%PR2GripperReleaseData gives an empty data for pr2_gripper_sensor_msgs/PR2GripperReleaseData

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_gripper_sensor_msgs/PR2GripperReleaseData';
...
info.MessageType = 'pr2_gripper_sensor_msgs/PR2GripperReleaseData';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
