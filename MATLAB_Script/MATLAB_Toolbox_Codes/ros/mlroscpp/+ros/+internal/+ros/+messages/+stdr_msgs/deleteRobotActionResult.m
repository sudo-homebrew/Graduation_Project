function [data, info] = deleteRobotActionResult
%DeleteRobotActionResult gives an empty data for stdr_msgs/DeleteRobotActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'stdr_msgs/DeleteRobotActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.stdr_msgs.deleteRobotResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'stdr_msgs/DeleteRobotActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
