function [data, info] = averagingActionResult
%AveragingActionResult gives an empty data for actionlib_tutorials/AveragingActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'actionlib_tutorials/AveragingActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.actionlib_tutorials.averagingResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'actionlib_tutorials/AveragingActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'result.mean';
info.MatPath{27} = 'result.std_dev';
