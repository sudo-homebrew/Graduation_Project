...
%KinematicSolverInfo gives an empty data for moveit_msgs/KinematicSolverInfo

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'moveit_msgs/KinematicSolverInfo';
[data.JointNames, info.JointNames] = ros.internal.ros.messages.ros.char('string',NaN);
[data.Limits, info.Limits] = ros.internal.ros.messages.moveit_msgs.jointLimits;
...
info.MessageType = 'moveit_msgs/KinematicSolverInfo';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
