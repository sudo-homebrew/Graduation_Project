function [data, info] = assembleScans2Response
%AssembleScans2 gives an empty data for laser_assembler/AssembleScans2Response

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'laser_assembler/AssembleScans2Response';
[data.Cloud, info.Cloud] = ros.internal.ros.messages.sensor_msgs.pointCloud2;
info.Cloud.MLdataType = 'struct';
info.MessageType = 'laser_assembler/AssembleScans2Response';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
