function [data, info] = stateActionResult
%StateActionResult gives an empty data for cob_script_server/StateActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_script_server/StateActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.cob_script_server.stateResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'cob_script_server/StateActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'result.return_value';
