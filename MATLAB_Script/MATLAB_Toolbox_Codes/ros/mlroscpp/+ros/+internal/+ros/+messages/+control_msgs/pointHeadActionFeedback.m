...
%PointHeadActionFeedback gives an empty data for control_msgs/PointHeadActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'control_msgs/PointHeadActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.control_msgs.pointHeadFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'control_msgs/PointHeadActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
