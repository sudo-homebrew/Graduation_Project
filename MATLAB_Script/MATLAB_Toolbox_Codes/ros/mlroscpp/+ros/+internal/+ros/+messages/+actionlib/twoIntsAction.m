function [data, info] = twoIntsAction
%TwoIntsAction gives an empty data for actionlib/TwoIntsAction

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'actionlib/TwoIntsAction';
[data.ActionGoal, info.ActionGoal] = ros.internal.ros.messages.actionlib.twoIntsActionGoal;
info.ActionGoal.MLdataType = 'struct';
[data.ActionResult, info.ActionResult] = ros.internal.ros.messages.actionlib.twoIntsActionResult;
info.ActionResult.MLdataType = 'struct';
[data.ActionFeedback, info.ActionFeedback] = ros.internal.ros.messages.actionlib.twoIntsActionFeedback;
info.ActionFeedback.MLdataType = 'struct';
info.MessageType = 'actionlib/TwoIntsAction';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{14} = 'action_goal.goal.a';
info.MatPath{15} = 'action_goal.goal.b';
...
info.MatPath{42} = 'action_result.result.sum';
