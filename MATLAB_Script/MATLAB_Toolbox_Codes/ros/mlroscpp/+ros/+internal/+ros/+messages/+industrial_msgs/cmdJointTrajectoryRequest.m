function [data, info] = cmdJointTrajectoryRequest
%CmdJointTrajectory gives an empty data for industrial_msgs/CmdJointTrajectoryRequest

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'industrial_msgs/CmdJointTrajectoryRequest';
...
info.MessageType = 'industrial_msgs/CmdJointTrajectoryRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
