function [data, info] = rawTurtlebotSensorState
%RawTurtlebotSensorState gives an empty data for create_node/RawTurtlebotSensorState

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'create_node/RawTurtlebotSensorState';
...
[data.RequestedVelocity, info.RequestedVelocity] = ros.internal.ros.messages.ros.default_type('int16',1);
[data.RequestedRadius, info.RequestedRadius] = ros.internal.ros.messages.ros.default_type('int16',1);
[data.RequestedRightVelocity, info.RequestedRightVelocity] = ros.internal.ros.messages.ros.default_type('int16',1);
[data.RequestedLeftVelocity, info.RequestedLeftVelocity] = ros.internal.ros.messages.ros.default_type('int16',1);
info.MessageType = 'create_node/RawTurtlebotSensorState';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{67} = 'user_digital_inputs';
info.MatPath{68} = 'user_analog_input';
info.MatPath{69} = 'charging_sources_available';
info.MatPath{70} = 'oi_mode';
info.MatPath{71} = 'song_number';
info.MatPath{72} = 'song_playing';
info.MatPath{73} = 'number_of_stream_packets';
info.MatPath{74} = 'requested_velocity';
info.MatPath{75} = 'requested_radius';
info.MatPath{76} = 'requested_right_velocity';
info.MatPath{77} = 'requested_left_velocity';
