...
%SingleJointPositionActionResult gives an empty data for control_msgs/SingleJointPositionActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'control_msgs/SingleJointPositionActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.control_msgs.singleJointPositionResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'control_msgs/SingleJointPositionActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
