function [data, info] = moveToPosition2DActionFeedback
%MoveToPosition2DActionFeedback gives an empty data for nav2d_navigator/MoveToPosition2DActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'nav2d_navigator/MoveToPosition2DActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.nav2d_navigator.moveToPosition2DFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'nav2d_navigator/MoveToPosition2DActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'feedback.distance';
