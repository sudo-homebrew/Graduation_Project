...
%GenerateGraspsActionResult gives an empty data for cob_grasp_generation/GenerateGraspsActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_grasp_generation/GenerateGraspsActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.cob_grasp_generation.generateGraspsResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'cob_grasp_generation/GenerateGraspsActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{27} = 'result.num_grasps';
