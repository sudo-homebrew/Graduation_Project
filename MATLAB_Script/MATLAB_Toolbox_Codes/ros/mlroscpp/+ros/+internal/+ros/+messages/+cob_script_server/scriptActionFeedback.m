function [data, info] = scriptActionFeedback
%ScriptActionFeedback gives an empty data for cob_script_server/ScriptActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_script_server/ScriptActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.cob_script_server.scriptFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'cob_script_server/ScriptActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
