...
%ConfigActionFeedback gives an empty data for laser_cb_detector/ConfigActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'laser_cb_detector/ConfigActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.laser_cb_detector.configFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'laser_cb_detector/ConfigActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
