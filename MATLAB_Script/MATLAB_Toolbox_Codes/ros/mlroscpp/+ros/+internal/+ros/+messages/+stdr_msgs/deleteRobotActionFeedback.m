function [data, info] = deleteRobotActionFeedback
%DeleteRobotActionFeedback gives an empty data for stdr_msgs/DeleteRobotActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'stdr_msgs/DeleteRobotActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.stdr_msgs.deleteRobotFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'stdr_msgs/DeleteRobotActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
