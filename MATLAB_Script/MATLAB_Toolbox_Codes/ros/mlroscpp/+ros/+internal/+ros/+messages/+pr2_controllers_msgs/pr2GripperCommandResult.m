function [data, info] = pr2GripperCommandResult
%Pr2GripperCommandResult gives an empty data for pr2_controllers_msgs/Pr2GripperCommandResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_controllers_msgs/Pr2GripperCommandResult';
...
info.MessageType = 'pr2_controllers_msgs/Pr2GripperCommandResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
