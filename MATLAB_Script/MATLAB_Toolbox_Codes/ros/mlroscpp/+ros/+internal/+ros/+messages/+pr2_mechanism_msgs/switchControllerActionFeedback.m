function [data, info] = switchControllerActionFeedback
%SwitchControllerActionFeedback gives an empty data for pr2_mechanism_msgs/SwitchControllerActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_mechanism_msgs/SwitchControllerActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.pr2_mechanism_msgs.switchControllerFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'pr2_mechanism_msgs/SwitchControllerActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
