function [data, info] = executeTrajectoryActionFeedback
%ExecuteTrajectoryActionFeedback gives an empty data for moveit_msgs/ExecuteTrajectoryActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'moveit_msgs/ExecuteTrajectoryActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.moveit_msgs.executeTrajectoryFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'moveit_msgs/ExecuteTrajectoryActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
