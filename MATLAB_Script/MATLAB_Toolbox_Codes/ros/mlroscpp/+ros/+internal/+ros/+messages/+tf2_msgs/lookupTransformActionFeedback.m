function [data, info] = lookupTransformActionFeedback
%LookupTransformActionFeedback gives an empty data for tf2_msgs/LookupTransformActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'tf2_msgs/LookupTransformActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.tf2_msgs.lookupTransformFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'tf2_msgs/LookupTransformActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
