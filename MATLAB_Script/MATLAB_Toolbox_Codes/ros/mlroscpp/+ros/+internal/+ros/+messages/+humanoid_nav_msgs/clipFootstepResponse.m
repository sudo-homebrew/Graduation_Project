function [data, info] = clipFootstepResponse
%ClipFootstep gives an empty data for humanoid_nav_msgs/ClipFootstepResponse

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'humanoid_nav_msgs/ClipFootstepResponse';
[data.Step, info.Step] = ros.internal.ros.messages.humanoid_nav_msgs.stepTarget;
info.Step.MLdataType = 'struct';
info.MessageType = 'humanoid_nav_msgs/ClipFootstepResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
