function [data, info] = execFootstepsActionResult
%ExecFootstepsActionResult gives an empty data for humanoid_nav_msgs/ExecFootstepsActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'humanoid_nav_msgs/ExecFootstepsActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.humanoid_nav_msgs.execFootstepsResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'humanoid_nav_msgs/ExecFootstepsActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'result.executed_footsteps';
info.MatPath{27} = 'result.executed_footsteps.pose';
info.MatPath{28} = 'result.executed_footsteps.pose.x';
info.MatPath{29} = 'result.executed_footsteps.pose.y';
info.MatPath{30} = 'result.executed_footsteps.pose.theta';
info.MatPath{31} = 'result.executed_footsteps.leg';
info.MatPath{32} = 'result.executed_footsteps.right';
info.MatPath{33} = 'result.executed_footsteps.left';
