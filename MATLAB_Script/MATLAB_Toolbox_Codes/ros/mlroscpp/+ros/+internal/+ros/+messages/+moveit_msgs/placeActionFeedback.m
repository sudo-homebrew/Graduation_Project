function [data, info] = placeActionFeedback
%PlaceActionFeedback gives an empty data for moveit_msgs/PlaceActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'moveit_msgs/PlaceActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.moveit_msgs.placeFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'moveit_msgs/PlaceActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
