function [data, info] = fibonacciActionResult
%FibonacciActionResult gives an empty data for actionlib_tutorials/FibonacciActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'actionlib_tutorials/FibonacciActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.actionlib_tutorials.fibonacciResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'actionlib_tutorials/FibonacciActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'result.sequence';
