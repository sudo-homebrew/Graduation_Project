...
%JointTrajectoryActionGoal gives an empty data for pr2_controllers_msgs/JointTrajectoryActionGoal

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_controllers_msgs/JointTrajectoryActionGoal';
[data.Header, info.Header] = ros.internal.ros.messages.std_msgs.header;
info.Header.MLdataType = 'struct';
[data.GoalId, info.GoalId] = ros.internal.ros.messages.actionlib_msgs.goalID;
info.GoalId.MLdataType = 'struct';
[data.Goal, info.Goal] = ros.internal.ros.messages.pr2_controllers_msgs.jointTrajectoryGoal;
info.Goal.MLdataType = 'struct';
info.MessageType = 'pr2_controllers_msgs/JointTrajectoryActionGoal';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
