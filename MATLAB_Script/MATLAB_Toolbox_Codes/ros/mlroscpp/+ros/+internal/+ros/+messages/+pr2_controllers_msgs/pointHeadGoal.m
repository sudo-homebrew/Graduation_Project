...
%PointHeadGoal gives an empty data for pr2_controllers_msgs/PointHeadGoal

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_controllers_msgs/PointHeadGoal';
...
info.MessageType = 'pr2_controllers_msgs/PointHeadGoal';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
