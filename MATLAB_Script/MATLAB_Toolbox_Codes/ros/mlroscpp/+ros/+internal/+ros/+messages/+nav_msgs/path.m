...
[data.Poses, info.Poses] = ros.internal.ros.messages.geometry_msgs.poseStamped;
...
info.MatPath{16} = 'poses.pose.position.x';
info.MatPath{17} = 'poses.pose.position.y';
info.MatPath{18} = 'poses.pose.position.z';
