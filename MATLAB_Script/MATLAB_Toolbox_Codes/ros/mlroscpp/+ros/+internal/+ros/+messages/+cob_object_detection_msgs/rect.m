...
%Rect gives an empty data for cob_object_detection_msgs/Rect

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'cob_object_detection_msgs/Rect';
...
info.MessageType = 'cob_object_detection_msgs/Rect';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
