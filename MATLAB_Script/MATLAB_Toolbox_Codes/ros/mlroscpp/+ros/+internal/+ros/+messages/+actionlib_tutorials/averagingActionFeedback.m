function [data, info] = averagingActionFeedback
%AveragingActionFeedback gives an empty data for actionlib_tutorials/AveragingActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'actionlib_tutorials/AveragingActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.actionlib_tutorials.averagingFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'actionlib_tutorials/AveragingActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'feedback.sample';
info.MatPath{27} = 'feedback.data';
info.MatPath{28} = 'feedback.mean';
info.MatPath{29} = 'feedback.std_dev';
