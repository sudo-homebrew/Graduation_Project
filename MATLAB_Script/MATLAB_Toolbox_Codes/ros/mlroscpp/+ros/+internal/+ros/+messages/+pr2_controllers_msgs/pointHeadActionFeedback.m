function [data, info] = pointHeadActionFeedback
%PointHeadActionFeedback gives an empty data for pr2_controllers_msgs/PointHeadActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_controllers_msgs/PointHeadActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.pr2_controllers_msgs.pointHeadFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'pr2_controllers_msgs/PointHeadActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'feedback.pointing_angle_error';
