function [data, info] = gripperSequenceActionResult
%GripperSequenceActionResult gives an empty data for pr2_precise_trajectory/GripperSequenceActionResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_precise_trajectory/GripperSequenceActionResult';
...
[data.Result, info.Result] = ros.internal.ros.messages.pr2_precise_trajectory.gripperSequenceResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'pr2_precise_trajectory/GripperSequenceActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
