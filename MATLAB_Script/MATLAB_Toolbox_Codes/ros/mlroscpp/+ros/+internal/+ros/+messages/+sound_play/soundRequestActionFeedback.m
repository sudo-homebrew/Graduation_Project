function [data, info] = soundRequestActionFeedback
%SoundRequestActionFeedback gives an empty data for sound_play/SoundRequestActionFeedback

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'sound_play/SoundRequestActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.messages.sound_play.soundRequestFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'sound_play/SoundRequestActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{26} = 'feedback.playing';
info.MatPath{27} = 'feedback.stamp';
info.MatPath{28} = 'feedback.stamp.sec';
info.MatPath{29} = 'feedback.stamp.nsec';
