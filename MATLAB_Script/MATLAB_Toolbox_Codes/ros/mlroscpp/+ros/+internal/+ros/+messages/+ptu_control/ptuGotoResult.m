function [data, info] = ptuGotoResult
%PtuGotoResult gives an empty data for ptu_control/PtuGotoResult

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'ptu_control/PtuGotoResult';
[data.State, info.State] = ros.internal.ros.messages.sensor_msgs.jointState;
info.State.MLdataType = 'struct';
info.MessageType = 'ptu_control/PtuGotoResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
