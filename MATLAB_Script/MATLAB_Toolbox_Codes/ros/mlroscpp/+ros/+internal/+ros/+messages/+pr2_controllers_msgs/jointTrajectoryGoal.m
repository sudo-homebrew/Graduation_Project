...
%JointTrajectoryGoal gives an empty data for pr2_controllers_msgs/JointTrajectoryGoal

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'pr2_controllers_msgs/JointTrajectoryGoal';
...
info.MessageType = 'pr2_controllers_msgs/JointTrajectoryGoal';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
