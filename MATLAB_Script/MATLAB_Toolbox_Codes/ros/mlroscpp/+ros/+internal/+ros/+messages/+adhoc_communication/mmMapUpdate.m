function [data, info] = mmMapUpdate
%MmMapUpdate gives an empty data for adhoc_communication/MmMapUpdate

% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
data.MessageType = 'adhoc_communication/MmMapUpdate';
...
info.MessageType = 'adhoc_communication/MmMapUpdate';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
