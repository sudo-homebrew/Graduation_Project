...
classdef ExecFootstepsFeedback < ros.Message
    %ExecFootstepsFeedback MATLAB implementation of humanoid_nav_msgs/ExecFootstepsFeedback
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'humanoid_nav_msgs/ExecFootstepsFeedback' % The ROS message type
    end
    ...
    methods
        function set.ExecutedFootsteps(obj, val)
            ...
            validateattributes(val, validClasses, validAttributes, 'ExecFootstepsFeedback', 'ExecutedFootsteps')
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.humanoid_nav_msgs.ExecFootstepsFeedback.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.humanoid_nav_msgs.ExecFootstepsFeedback(strObj);
        end
    end
end
