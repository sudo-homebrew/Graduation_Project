...
classdef ControllerStatistics < ros.Message
    %ControllerStatistics MATLAB implementation of pr2_mechanism_msgs/ControllerStatistics
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'pr2_mechanism_msgs/ControllerStatistics' % The ROS message type
    end
    properties (Constant, Hidden)
        MD5Checksum = '6d15d137eea402018e3c7c8dbecd4b95' % The MD5 Checksum of the message definition
        PropertyList = { 'Timestamp' 'MaxTime' 'MeanTime' 'VarianceTime' 'TimeLastControlLoopOverrun' 'Name' 'Running' 'NumControlLoopOverruns' } % List of non-constant message properties
        ROSPropertyList = { 'timestamp' 'max_time' 'mean_time' 'variance_time' 'time_last_control_loop_overrun' 'name' 'running' 'num_control_loop_overruns' } % List of non-constant ROS message properties
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.pr2_mechanism_msgs.ControllerStatistics.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.pr2_mechanism_msgs.ControllerStatistics(strObj);
        end
    end
end
