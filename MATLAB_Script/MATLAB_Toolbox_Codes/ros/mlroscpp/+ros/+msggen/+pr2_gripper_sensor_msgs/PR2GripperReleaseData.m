...
classdef PR2GripperReleaseData < ros.Message
    ...
    methods
        function set.Rtstate(obj, val)
            ...
            validateattributes(val, validClasses, validAttributes, 'PR2GripperReleaseData', 'Rtstate')
            obj.Rtstate = val;
        end
    end
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.pr2_gripper_sensor_msgs.PR2GripperReleaseData.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.pr2_gripper_sensor_msgs.PR2GripperReleaseData(strObj);
        end
    end
end
