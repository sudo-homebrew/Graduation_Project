...
classdef SaveMapResponse < ros.Message
    %SaveMapResponse MATLAB implementation of map_msgs/SaveMapResponse
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'map_msgs/SaveMapResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.map_msgs.SaveMapResponse.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.map_msgs.SaveMapResponse(strObj);
        end
    end
end
