...
classdef TurtlebotSensorState < ros.Message
    ...
    methods
        function set.Header(obj, val)
            ...
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'Header')
            obj.Header = val;
        end
        function set.BumpsWheeldrops(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'BumpsWheeldrops');
            obj.BumpsWheeldrops = uint8(val);
        end
        function set.Wall(obj, val)
            validClasses = {'logical', 'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'Wall');
            obj.Wall = logical(val);
        end
        function set.CliffLeft(obj, val)
            validClasses = {'logical', 'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'CliffLeft');
            obj.CliffLeft = logical(val);
        end
        function set.CliffFrontLeft(obj, val)
            validClasses = {'logical', 'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'CliffFrontLeft');
            obj.CliffFrontLeft = logical(val);
        end
        function set.CliffFrontRight(obj, val)
            validClasses = {'logical', 'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'CliffFrontRight');
            obj.CliffFrontRight = logical(val);
        end
        function set.CliffRight(obj, val)
            validClasses = {'logical', 'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'CliffRight');
            obj.CliffRight = logical(val);
        end
        function set.VirtualWall(obj, val)
            validClasses = {'logical', 'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'VirtualWall');
            obj.VirtualWall = logical(val);
        end
        function set.MotorOvercurrents(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'MotorOvercurrents');
            obj.MotorOvercurrents = uint8(val);
        end
        function set.DirtDetectorLeft(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'DirtDetectorLeft');
            obj.DirtDetectorLeft = uint8(val);
        end
        function set.DirtDetectorRight(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'DirtDetectorRight');
            obj.DirtDetectorRight = uint8(val);
        end
        function set.RemoteOpcode(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'RemoteOpcode');
            obj.RemoteOpcode = uint8(val);
        end
        function set.Buttons(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'Buttons');
            obj.Buttons = uint8(val);
        end
        function set.Distance(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'Distance');
            obj.Distance = double(val);
        end
        function set.Angle(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'Angle');
            obj.Angle = double(val);
        end
        function set.ChargingState(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'ChargingState');
            obj.ChargingState = uint8(val);
        end
        function set.Voltage(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'Voltage');
            obj.Voltage = uint16(val);
        end
        function set.Current(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'Current');
            obj.Current = int16(val);
        end
        function set.Temperature(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'Temperature');
            obj.Temperature = int8(val);
        end
        function set.Charge(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'Charge');
            obj.Charge = uint16(val);
        end
        function set.Capacity(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'Capacity');
            obj.Capacity = uint16(val);
        end
        function set.WallSignal(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'WallSignal');
            obj.WallSignal = uint16(val);
        end
        function set.CliffLeftSignal(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'CliffLeftSignal');
            obj.CliffLeftSignal = uint16(val);
        end
        function set.CliffFrontLeftSignal(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'CliffFrontLeftSignal');
            obj.CliffFrontLeftSignal = uint16(val);
        end
        function set.CliffFrontRightSignal(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'CliffFrontRightSignal');
            obj.CliffFrontRightSignal = uint16(val);
        end
        function set.CliffRightSignal(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'CliffRightSignal');
            obj.CliffRightSignal = uint16(val);
        end
        function set.UserDigitalOutputs(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'UserDigitalOutputs');
            obj.UserDigitalOutputs = uint8(val);
        end
        function set.UserDigitalInputs(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'UserDigitalInputs');
            obj.UserDigitalInputs = uint8(val);
        end
        function set.UserAnalogInput(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'UserAnalogInput');
            obj.UserAnalogInput = uint16(val);
        end
        function set.ChargingSourcesAvailable(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'ChargingSourcesAvailable');
            obj.ChargingSourcesAvailable = uint8(val);
        end
        function set.OiMode(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'OiMode');
            obj.OiMode = uint8(val);
        end
        function set.SongNumber(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'SongNumber');
            obj.SongNumber = uint8(val);
        end
        function set.SongPlaying(obj, val)
            validClasses = {'logical', 'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'SongPlaying');
            obj.SongPlaying = logical(val);
        end
        function set.NumberOfStreamPackets(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'NumberOfStreamPackets');
            obj.NumberOfStreamPackets = uint8(val);
        end
        function set.RequestedVelocity(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'RequestedVelocity');
            obj.RequestedVelocity = int32(val);
        end
        function set.RequestedRadius(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'RequestedRadius');
            obj.RequestedRadius = int32(val);
        end
        function set.RequestedRightVelocity(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'RequestedRightVelocity');
            obj.RequestedRightVelocity = int32(val);
        end
        function set.RequestedLeftVelocity(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'TurtlebotSensorState', 'RequestedLeftVelocity');
            obj.RequestedLeftVelocity = int32(val);
        end
    end
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.create_node.TurtlebotSensorState.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.create_node.TurtlebotSensorState(strObj);
        end
    end
end
