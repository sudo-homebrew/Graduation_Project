...
classdef EmptyResponse < ros.Message
    %EmptyResponse MATLAB implementation of std_srvs/EmptyResponse
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'std_srvs/EmptyResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.std_srvs.EmptyResponse.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.std_srvs.EmptyResponse(strObj);
        end
    end
end
