...
classdef EmptyRequest < ros.Message
    %EmptyRequest MATLAB implementation of std_srvs/EmptyRequest
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'std_srvs/EmptyRequest' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.std_srvs.EmptyRequest.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.std_srvs.EmptyRequest(strObj);
        end
    end
end
