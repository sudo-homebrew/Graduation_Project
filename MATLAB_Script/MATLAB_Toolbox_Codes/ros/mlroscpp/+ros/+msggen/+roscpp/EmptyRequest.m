...
classdef EmptyRequest < ros.Message
    %EmptyRequest MATLAB implementation of roscpp/EmptyRequest
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'roscpp/EmptyRequest' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.roscpp.EmptyRequest.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.roscpp.EmptyRequest(strObj);
        end
    end
end
