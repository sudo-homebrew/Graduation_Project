...
classdef EmptyResponse < ros.Message
    %EmptyResponse MATLAB implementation of roscpp/EmptyResponse
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'roscpp/EmptyResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.roscpp.EmptyResponse.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.roscpp.EmptyResponse(strObj);
        end
    end
end
