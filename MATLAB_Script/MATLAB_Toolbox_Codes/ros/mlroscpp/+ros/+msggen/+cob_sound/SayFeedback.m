...
classdef SayFeedback < ros.Message
    %SayFeedback MATLAB implementation of cob_sound/SayFeedback
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'cob_sound/SayFeedback' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.cob_sound.SayFeedback.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.cob_sound.SayFeedback(strObj);
        end
    end
end
