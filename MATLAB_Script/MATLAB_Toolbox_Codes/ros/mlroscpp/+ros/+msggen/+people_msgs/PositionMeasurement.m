...
classdef PositionMeasurement < ros.Message
    %PositionMeasurement MATLAB implementation of people_msgs/PositionMeasurement
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'people_msgs/PositionMeasurement' % The ROS message type
    end
    properties (Constant, Hidden)
        MD5Checksum = '54fa938b4ec28728e01575b79eb0ec7c' % The MD5 Checksum of the message definition
        PropertyList = { 'Header' 'Pos' 'Name' 'ObjectId' 'Reliability' 'Covariance' 'Initialization' } % List of non-constant message properties
        ROSPropertyList = { 'header' 'pos' 'name' 'object_id' 'reliability' 'covariance' 'initialization' } % List of non-constant ROS message properties
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.people_msgs.PositionMeasurement.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.people_msgs.PositionMeasurement(strObj);
        end
    end
end
