...
classdef RelaxRequest < ros.Message
    %RelaxRequest MATLAB implementation of arbotix_msgs/RelaxRequest
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'arbotix_msgs/RelaxRequest' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.arbotix_msgs.RelaxRequest.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.arbotix_msgs.RelaxRequest(strObj);
        end
    end
end
