...
classdef SingleJointPositionActionResult < ros.Message
    %SingleJointPositionActionResult MATLAB implementation of pr2_controllers_msgs/SingleJointPositionActionResult
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'pr2_controllers_msgs/SingleJointPositionActionResult' % The ROS message type
    end
    properties (Constant, Hidden)
        ...
        PropertyMessageTypes = { 'ros.msggen.std_msgs.Header' ...
            ...
            'ros.msggen.pr2_controllers_msgs.SingleJointPositionResult' ...
    ...
    methods
        ...
        function set.Result(obj, val)
            validAttributes = {'nonempty', 'scalar'};
            validClasses = {'ros.msggen.pr2_controllers_msgs.SingleJointPositionResult'};
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.pr2_controllers_msgs.SingleJointPositionActionResult.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.pr2_controllers_msgs.SingleJointPositionActionResult(strObj);
        end
    end
end
