...
classdef JointTrajectoryControllerState < ros.Message
    %JointTrajectoryControllerState MATLAB implementation of pr2_controllers_msgs/JointTrajectoryControllerState
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'pr2_controllers_msgs/JointTrajectoryControllerState' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.pr2_controllers_msgs.JointTrajectoryControllerState.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.pr2_controllers_msgs.JointTrajectoryControllerState(strObj);
        end
    end
end
