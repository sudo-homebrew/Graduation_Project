...
classdef ConfigFeedback < ros.Message
    %ConfigFeedback MATLAB implementation of interval_intersection/ConfigFeedback
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'interval_intersection/ConfigFeedback' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.interval_intersection.ConfigFeedback.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.interval_intersection.ConfigFeedback(strObj);
        end
    end
end
