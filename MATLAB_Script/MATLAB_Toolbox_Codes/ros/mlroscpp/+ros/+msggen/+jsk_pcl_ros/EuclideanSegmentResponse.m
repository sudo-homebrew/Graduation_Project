...
classdef EuclideanSegmentResponse < ros.Message
    %EuclideanSegmentResponse MATLAB implementation of jsk_pcl_ros/EuclideanSegmentResponse
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'jsk_pcl_ros/EuclideanSegmentResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.jsk_pcl_ros.EuclideanSegmentResponse.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.jsk_pcl_ros.EuclideanSegmentResponse(strObj);
        end
    end
end
