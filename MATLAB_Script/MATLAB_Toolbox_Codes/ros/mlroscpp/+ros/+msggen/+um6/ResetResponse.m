...
classdef ResetResponse < ros.Message
    %ResetResponse MATLAB implementation of um6/ResetResponse
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'um6/ResetResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.um6.ResetResponse.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.um6.ResetResponse(strObj);
        end
    end
end
