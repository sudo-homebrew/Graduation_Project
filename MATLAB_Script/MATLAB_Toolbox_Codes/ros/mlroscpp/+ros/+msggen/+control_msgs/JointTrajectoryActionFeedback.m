...
classdef JointTrajectoryActionFeedback < ros.Message
    %JointTrajectoryActionFeedback MATLAB implementation of control_msgs/JointTrajectoryActionFeedback
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'control_msgs/JointTrajectoryActionFeedback' % The ROS message type
    end
    properties (Constant, Hidden)
        ...
        PropertyMessageTypes = { 'ros.msggen.std_msgs.Header' ...
            ...
            'ros.msggen.control_msgs.JointTrajectoryFeedback' ...
    ...
    methods
        ...
        function set.Feedback(obj, val)
            validAttributes = {'nonempty', 'scalar'};
            validClasses = {'ros.msggen.control_msgs.JointTrajectoryFeedback'};
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.control_msgs.JointTrajectoryActionFeedback.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.control_msgs.JointTrajectoryActionFeedback(strObj);
        end
    end
end
