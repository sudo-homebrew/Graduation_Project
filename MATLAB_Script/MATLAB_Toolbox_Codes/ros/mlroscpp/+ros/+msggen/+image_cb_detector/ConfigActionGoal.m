...
classdef ConfigActionGoal < ros.Message
    %ConfigActionGoal MATLAB implementation of image_cb_detector/ConfigActionGoal
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'image_cb_detector/ConfigActionGoal' % The ROS message type
    end
    properties (Constant, Hidden)
        MD5Checksum = '47438deb496822a5e3dc575b6081de23' % The MD5 Checksum of the message definition
        ...
        PropertyMessageTypes = { 'ros.msggen.std_msgs.Header' ...
            ...
            'ros.msggen.image_cb_detector.ConfigGoal' ...
    ...
    methods
        ...
        function set.Goal(obj, val)
            validAttributes = {'nonempty', 'scalar'};
            validClasses = {'ros.msggen.image_cb_detector.ConfigGoal'};
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.image_cb_detector.ConfigActionGoal.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.image_cb_detector.ConfigActionGoal(strObj);
        end
    end
end
