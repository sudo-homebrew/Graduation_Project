...
classdef KinematicSolverInfo < ros.Message
    %KinematicSolverInfo MATLAB implementation of iai_kinematics_msgs/KinematicSolverInfo
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'iai_kinematics_msgs/KinematicSolverInfo' % The ROS message type
    end
    properties (Constant, Hidden)
        ...
        PropertyMessageTypes = { 'ros.msggen.iai_kinematics_msgs.JointLimits' ...
            '' ...
            '' ...
    ...
    methods
        function set.Limits(obj, val)
            if isempty(val)
                % Allow empty [] input
                val = ros.msggen.iai_kinematics_msgs.JointLimits.empty(0, 1);
            end
            val = val(:);
            validAttributes = {'vector'};
            validClasses = {'ros.msggen.iai_kinematics_msgs.JointLimits'};
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.iai_kinematics_msgs.KinematicSolverInfo.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.iai_kinematics_msgs.KinematicSolverInfo(strObj);
        end
    end
end
