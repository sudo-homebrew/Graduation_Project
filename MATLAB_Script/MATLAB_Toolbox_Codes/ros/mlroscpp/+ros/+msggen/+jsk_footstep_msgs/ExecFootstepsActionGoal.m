...
classdef ExecFootstepsActionGoal < ros.Message
    %ExecFootstepsActionGoal MATLAB implementation of jsk_footstep_msgs/ExecFootstepsActionGoal
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'jsk_footstep_msgs/ExecFootstepsActionGoal' % The ROS message type
    end
    properties (Constant, Hidden)
        MD5Checksum = '372b1af785ac3d68de298051693d4bfd' % The MD5 Checksum of the message definition
        ...
        PropertyMessageTypes = { 'ros.msggen.std_msgs.Header' ...
            ...
            'ros.msggen.jsk_footstep_msgs.ExecFootstepsGoal' ...
    ...
    methods
        ...
        function set.Goal(obj, val)
            validAttributes = {'nonempty', 'scalar'};
            validClasses = {'ros.msggen.jsk_footstep_msgs.ExecFootstepsGoal'};
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.jsk_footstep_msgs.ExecFootstepsActionGoal.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.jsk_footstep_msgs.ExecFootstepsActionGoal(strObj);
        end
    end
end
