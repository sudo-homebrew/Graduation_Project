...
classdef ConfigFeedback < ros.Message
    %ConfigFeedback MATLAB implementation of laser_cb_detector/ConfigFeedback
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'laser_cb_detector/ConfigFeedback' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.laser_cb_detector.ConfigFeedback.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.laser_cb_detector.ConfigFeedback(strObj);
        end
    end
end
