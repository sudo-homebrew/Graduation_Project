...
classdef SyncMasterInfo < ros.Message
    %SyncMasterInfo MATLAB implementation of multimaster_msgs_fkie/SyncMasterInfo
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'multimaster_msgs_fkie/SyncMasterInfo' % The ROS message type
    end
    properties (Constant, Hidden)
        ...
        PropertyMessageTypes = { 'ros.msggen.multimaster_msgs_fkie.SyncTopicInfo' ...
            'ros.msggen.multimaster_msgs_fkie.SyncTopicInfo' ...
            'ros.msggen.multimaster_msgs_fkie.SyncServiceInfo' ...
            '' ...
            '' ...
    ...
    methods
        function set.Publisher(obj, val)
            if isempty(val)
                % Allow empty [] input
                val = ros.msggen.multimaster_msgs_fkie.SyncTopicInfo.empty(0, 1);
            end
            val = val(:);
            validAttributes = {'vector'};
            validClasses = {'ros.msggen.multimaster_msgs_fkie.SyncTopicInfo'};
        ...
        function set.Services(obj, val)
            if isempty(val)
                % Allow empty [] input
                val = ros.msggen.multimaster_msgs_fkie.SyncServiceInfo.empty(0, 1);
            end
            val = val(:);
            validAttributes = {'vector'};
            validClasses = {'ros.msggen.multimaster_msgs_fkie.SyncServiceInfo'};
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.multimaster_msgs_fkie.SyncMasterInfo.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.multimaster_msgs_fkie.SyncMasterInfo(strObj);
        end
    end
end
