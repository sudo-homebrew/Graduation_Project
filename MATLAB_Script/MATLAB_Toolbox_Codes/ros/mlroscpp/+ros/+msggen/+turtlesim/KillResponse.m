...
classdef KillResponse < ros.Message
    %KillResponse MATLAB implementation of turtlesim/KillResponse
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'turtlesim/KillResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.turtlesim.KillResponse.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.turtlesim.KillResponse(strObj);
        end
    end
end
