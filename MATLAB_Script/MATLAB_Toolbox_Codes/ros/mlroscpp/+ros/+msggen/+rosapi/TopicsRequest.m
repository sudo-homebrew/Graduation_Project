...
classdef TopicsRequest < ros.Message
    %TopicsRequest MATLAB implementation of rosapi/TopicsRequest
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'rosapi/TopicsRequest' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.rosapi.TopicsRequest.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.rosapi.TopicsRequest(strObj);
        end
    end
end
