...
classdef SetParamResponse < ros.Message
    %SetParamResponse MATLAB implementation of rosapi/SetParamResponse
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.

    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'rosapi/SetParamResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.rosapi.SetParamResponse.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.rosapi.SetParamResponse(strObj);
        end
    end
end
