...
bool operator==(const ::adhoc_communication::ExpAuction_<ContainerAllocator1> & lhs, const ::adhoc_communication::ExpAuction_<ContainerAllocator2> & rhs)
{
  return lhs.auction_status_message == rhs.auction_status_message &&
    lhs.start_auction == rhs.start_auction &&
    lhs.auction_finished == rhs.auction_finished &&
    lhs.occupied_ids == rhs.occupied_ids &&
    lhs.requested_clusters == rhs.requested_clusters &&
    lhs.auction_id == rhs.auction_id &&
    lhs.robot_name == rhs.robot_name &&
    lhs.available_clusters == rhs.available_clusters;
}
