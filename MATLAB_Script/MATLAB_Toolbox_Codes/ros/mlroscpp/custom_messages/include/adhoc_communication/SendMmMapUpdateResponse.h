...
bool operator==(const ::adhoc_communication::SendMmMapUpdateResponse_<ContainerAllocator1> & lhs, const ::adhoc_communication::SendMmMapUpdateResponse_<ContainerAllocator2> & rhs)
{
