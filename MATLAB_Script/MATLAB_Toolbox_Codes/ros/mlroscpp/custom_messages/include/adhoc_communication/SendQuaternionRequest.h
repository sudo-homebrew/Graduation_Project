...
bool operator==(const ::adhoc_communication::SendQuaternionRequest_<ContainerAllocator1> & lhs, const ::adhoc_communication::SendQuaternionRequest_<ContainerAllocator2> & rhs)
{
