...
bool operator==(const ::adhoc_communication::GetGroupStateResponse_<ContainerAllocator1> & lhs, const ::adhoc_communication::GetGroupStateResponse_<ContainerAllocator2> & rhs)
{
  return lhs.member == rhs.member &&
    ...
    lhs.route_uplink == rhs.route_uplink &&
    lhs.downlinks == rhs.downlinks;
}
