...
bool operator==(const ::adhoc_communication::SendExpAuctionResponse_<ContainerAllocator1> & lhs, const ::adhoc_communication::SendExpAuctionResponse_<ContainerAllocator2> & rhs)
{
