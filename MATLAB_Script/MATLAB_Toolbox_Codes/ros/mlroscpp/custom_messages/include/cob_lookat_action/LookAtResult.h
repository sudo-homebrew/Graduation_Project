// Generated by gencpp from file cob_lookat_action/LookAtResult.msg
// DO NOT EDIT!
...
bool operator==(const ::cob_lookat_action::LookAtResult_<ContainerAllocator1> & lhs, const ::cob_lookat_action::LookAtResult_<ContainerAllocator2> & rhs)
{
