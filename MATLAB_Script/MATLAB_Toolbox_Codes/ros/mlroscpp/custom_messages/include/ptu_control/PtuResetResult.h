// Generated by gencpp from file ptu_control/PtuResetResult.msg
// DO NOT EDIT!
...
template <class ContainerAllocator>
struct IsFixedSize< ::ptu_control::PtuResetResult_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ptu_control::PtuResetResult_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ptu_control::PtuResetResult_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ptu_control::PtuResetResult_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ptu_control::PtuResetResult_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ptu_control::PtuResetResult_<ContainerAllocator> const>
  : FalseType
  { };
...
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::ptu_control::PtuResetResult_<ContainerAllocator>&)
  {}
};
