// Generated by gencpp from file ptu_control/PtuGotoAction.msg
// DO NOT EDIT!
...
template <class ContainerAllocator>
struct IsFixedSize< ::ptu_control::PtuGotoAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ptu_control::PtuGotoAction_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ptu_control::PtuGotoAction_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ptu_control::PtuGotoAction_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ptu_control::PtuGotoAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ptu_control::PtuGotoAction_<ContainerAllocator> const>
  : FalseType
  { };
