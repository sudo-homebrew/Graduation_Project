// Generated by gencpp from file ptu_control/PtuResetActionGoal.msg
// DO NOT EDIT!
...
template <class ContainerAllocator>
struct IsFixedSize< ::ptu_control::PtuResetActionGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ptu_control::PtuResetActionGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ptu_control::PtuResetActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ptu_control::PtuResetActionGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ptu_control::PtuResetActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ptu_control::PtuResetActionGoal_<ContainerAllocator> const>
  : TrueType
  { };
