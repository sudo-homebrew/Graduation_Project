// Generated by gencpp from file jsk_perception/WhiteBalanceResponse.msg
// DO NOT EDIT!


#ifndef JSK_PERCEPTION_MESSAGE_WHITEBALANCERESPONSE_H
#define JSK_PERCEPTION_MESSAGE_WHITEBALANCERESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::jsk_perception::WhiteBalanceResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::jsk_perception::WhiteBalanceResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::jsk_perception::WhiteBalanceResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::jsk_perception::WhiteBalanceResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::jsk_perception::WhiteBalanceResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::jsk_perception::WhiteBalanceResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::jsk_perception::WhiteBalanceResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::jsk_perception::WhiteBalanceResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::jsk_perception::WhiteBalanceResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::jsk_perception::WhiteBalanceResponse_<ContainerAllocator>& v)
  {
    s << indent << "output: ";
    s << std::endl;
...
#endif // JSK_PERCEPTION_MESSAGE_WHITEBALANCERESPONSE_H
