...
struct MD5Sum< ::mavros_msgs::CommandCode_<ContainerAllocator> >
{
  ...
  {
    return "657a801f1667d58c54ee4db6ce4dbb94";
  }

  static const char* value(const ::mavros_msgs::CommandCode_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x657a801f1667d58cULL;
  static const uint64_t static_value2 = 0x54ee4db6ce4dbb94ULL;
};
...
"\n"
"# [[[end]]] (checksum: 7e9e4e30250b6e125a5c89accc262250)\n"
;
  }
