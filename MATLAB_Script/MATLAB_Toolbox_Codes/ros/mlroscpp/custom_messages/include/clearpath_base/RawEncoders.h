// Generated by gencpp from file clearpath_base/RawEncoders.msg
// DO NOT EDIT!
...
bool operator==(const ::clearpath_base::RawEncoders_<ContainerAllocator1> & lhs, const ::clearpath_base::RawEncoders_<ContainerAllocator2> & rhs)
{
