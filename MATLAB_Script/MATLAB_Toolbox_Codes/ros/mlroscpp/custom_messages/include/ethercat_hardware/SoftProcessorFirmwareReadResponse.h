// Generated by gencpp from file ethercat_hardware/SoftProcessorFirmwareReadResponse.msg
// DO NOT EDIT!


#ifndef ETHERCAT_HARDWARE_MESSAGE_SOFTPROCESSORFIRMWAREREADRESPONSE_H
#define ETHERCAT_HARDWARE_MESSAGE_SOFTPROCESSORFIRMWAREREADRESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::ethercat_hardware::SoftProcessorFirmwareReadResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ethercat_hardware::SoftProcessorFirmwareReadResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ethercat_hardware::SoftProcessorFirmwareReadResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ethercat_hardware::SoftProcessorFirmwareReadResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ethercat_hardware::SoftProcessorFirmwareReadResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ethercat_hardware::SoftProcessorFirmwareReadResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ethercat_hardware::SoftProcessorFirmwareReadResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ethercat_hardware::SoftProcessorFirmwareReadResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::ethercat_hardware::SoftProcessorFirmwareReadResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ethercat_hardware::SoftProcessorFirmwareReadResponse_<ContainerAllocator>& v)
  {
    s << indent << "success: ";
...
#endif // ETHERCAT_HARDWARE_MESSAGE_SOFTPROCESSORFIRMWAREREADRESPONSE_H
