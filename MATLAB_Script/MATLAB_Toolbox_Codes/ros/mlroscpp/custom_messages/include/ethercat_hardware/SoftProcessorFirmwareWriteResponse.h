// Generated by gencpp from file ethercat_hardware/SoftProcessorFirmwareWriteResponse.msg
// DO NOT EDIT!


#ifndef ETHERCAT_HARDWARE_MESSAGE_SOFTPROCESSORFIRMWAREWRITERESPONSE_H
#define ETHERCAT_HARDWARE_MESSAGE_SOFTPROCESSORFIRMWAREWRITERESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::ethercat_hardware::SoftProcessorFirmwareWriteResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ethercat_hardware::SoftProcessorFirmwareWriteResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ethercat_hardware::SoftProcessorFirmwareWriteResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ethercat_hardware::SoftProcessorFirmwareWriteResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ethercat_hardware::SoftProcessorFirmwareWriteResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ethercat_hardware::SoftProcessorFirmwareWriteResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ethercat_hardware::SoftProcessorFirmwareWriteResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ethercat_hardware::SoftProcessorFirmwareWriteResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::ethercat_hardware::SoftProcessorFirmwareWriteResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ethercat_hardware::SoftProcessorFirmwareWriteResponse_<ContainerAllocator>& v)
  {
    s << indent << "success: ";
...
#endif // ETHERCAT_HARDWARE_MESSAGE_SOFTPROCESSORFIRMWAREWRITERESPONSE_H
