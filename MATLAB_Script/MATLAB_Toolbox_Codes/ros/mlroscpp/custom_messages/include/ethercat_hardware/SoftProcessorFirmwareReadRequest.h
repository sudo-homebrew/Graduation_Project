// Generated by gencpp from file ethercat_hardware/SoftProcessorFirmwareReadRequest.msg
// DO NOT EDIT!


#ifndef ETHERCAT_HARDWARE_MESSAGE_SOFTPROCESSORFIRMWAREREADREQUEST_H
#define ETHERCAT_HARDWARE_MESSAGE_SOFTPROCESSORFIRMWAREREADREQUEST_H
...
std::ostream& operator<<(std::ostream& s, const ::ethercat_hardware::SoftProcessorFirmwareReadRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ethercat_hardware::SoftProcessorFirmwareReadRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ethercat_hardware::SoftProcessorFirmwareReadRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ethercat_hardware::SoftProcessorFirmwareReadRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ethercat_hardware::SoftProcessorFirmwareReadRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ethercat_hardware::SoftProcessorFirmwareReadRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ethercat_hardware::SoftProcessorFirmwareReadRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ethercat_hardware::SoftProcessorFirmwareReadRequest_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::ethercat_hardware::SoftProcessorFirmwareReadRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ethercat_hardware::SoftProcessorFirmwareReadRequest_<ContainerAllocator>& v)
  {
...
#endif // ETHERCAT_HARDWARE_MESSAGE_SOFTPROCESSORFIRMWAREREADREQUEST_H
