// Generated by gencpp from file app_manager/AppInstallationState.msg
// DO NOT EDIT!
...
template <class ContainerAllocator>
struct IsFixedSize< ::app_manager::AppInstallationState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::app_manager::AppInstallationState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::app_manager::AppInstallationState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::app_manager::AppInstallationState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::app_manager::AppInstallationState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::app_manager::AppInstallationState_<ContainerAllocator> const>
  : FalseType
  { };
