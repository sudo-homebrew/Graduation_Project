// Generated by gencpp from file app_manager/ExchangeApp.msg
// DO NOT EDIT!
...
template <class ContainerAllocator>
struct IsFixedSize< ::app_manager::ExchangeApp_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::app_manager::ExchangeApp_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::app_manager::ExchangeApp_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::app_manager::ExchangeApp_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::app_manager::ExchangeApp_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::app_manager::ExchangeApp_<ContainerAllocator> const>
  : FalseType
  { };
