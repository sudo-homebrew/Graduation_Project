// Generated by gencpp from file app_manager/StopAppRequest.msg
// DO NOT EDIT!


#ifndef APP_MANAGER_MESSAGE_STOPAPPREQUEST_H
#define APP_MANAGER_MESSAGE_STOPAPPREQUEST_H
...
std::ostream& operator<<(std::ostream& s, const ::app_manager::StopAppRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::app_manager::StopAppRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::app_manager::StopAppRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::app_manager::StopAppRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::app_manager::StopAppRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::app_manager::StopAppRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::app_manager::StopAppRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::app_manager::StopAppRequest_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::app_manager::StopAppRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::app_manager::StopAppRequest_<ContainerAllocator>& v)
  {
    s << indent << "name: ";
...
#endif // APP_MANAGER_MESSAGE_STOPAPPREQUEST_H
