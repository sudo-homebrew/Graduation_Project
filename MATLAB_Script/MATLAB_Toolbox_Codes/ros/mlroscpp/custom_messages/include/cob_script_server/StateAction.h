// Generated by gencpp from file cob_script_server/StateAction.msg
// DO NOT EDIT!
...
bool operator==(const ::cob_script_server::StateAction_<ContainerAllocator1> & lhs, const ::cob_script_server::StateAction_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::cob_script_server::StateAction_<ContainerAllocator> >
{
  ...
  {
    return "40f8241715c1af1ecd09c2bda397f113";
  }

  static const char* value(const ::cob_script_server::StateAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x40f8241715c1af1eULL;
  static const uint64_t static_value2 = 0xcd09c2bda397f113ULL;
};
