...
struct MD5Sum< ::designator_integration_msgs::DesignatorCommunicationRequest_<ContainerAllocator> >
{
  ...
  {
    return "6949a26db11a1131db0d1dd5dc7c65c4";
  }
  ...
  static const uint64_t static_value1 = 0x6949a26db11a1131ULL;
  static const uint64_t static_value2 = 0xdb0d1dd5dc7c65c4ULL;
};
