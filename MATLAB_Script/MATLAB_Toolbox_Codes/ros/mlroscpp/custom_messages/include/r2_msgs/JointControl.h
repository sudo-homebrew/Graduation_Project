// Generated by gencpp from file r2_msgs/JointControl.msg
// DO NOT EDIT!


#ifndef R2_MSGS_MESSAGE_JOINTCONTROL_H
#define R2_MSGS_MESSAGE_JOINTCONTROL_H
...
typedef ::r2_msgs::JointControl_<std::allocator<void> > JointControl;

typedef boost::shared_ptr< ::r2_msgs::JointControl > JointControlPtr;
typedef boost::shared_ptr< ::r2_msgs::JointControl const> JointControlConstPtr;
...
{
ros::message_operations::Printer< ::r2_msgs::JointControl_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::r2_msgs::JointControl_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::r2_msgs::JointControl_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::r2_msgs::JointControl_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::r2_msgs::JointControl_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::r2_msgs::JointControl_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::r2_msgs::JointControl_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::r2_msgs::JointControl_<ContainerAllocator> >
{
  ...
  static const char* value(const ::r2_msgs::JointControl_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe38c02f4ffdedb57ULL;
  static const uint64_t static_value2 = 0x646a4576b7e0ccf6ULL;
};

template<class ContainerAllocator>
struct DataType< ::r2_msgs::JointControl_<ContainerAllocator> >
{
  static const char* value()
  {
    return "r2_msgs/JointControl";
  }
...
template<class ContainerAllocator>
struct Definition< ::r2_msgs::JointControl_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::r2_msgs::JointControl_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::r2_msgs::JointControl_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::r2_msgs::JointControl_<ContainerAllocator>& v)
  {
    s << indent << "publisher: ";
...
#endif // R2_MSGS_MESSAGE_JOINTCONTROL_H
