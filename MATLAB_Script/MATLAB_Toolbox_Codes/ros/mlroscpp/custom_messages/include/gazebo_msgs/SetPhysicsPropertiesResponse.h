...
bool operator==(const ::gazebo_msgs::SetPhysicsPropertiesResponse_<ContainerAllocator1> & lhs, const ::gazebo_msgs::SetPhysicsPropertiesResponse_<ContainerAllocator2> & rhs)
{
