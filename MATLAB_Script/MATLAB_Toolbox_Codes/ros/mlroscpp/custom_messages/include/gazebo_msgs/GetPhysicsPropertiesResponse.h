...
bool operator==(const ::gazebo_msgs::GetPhysicsPropertiesResponse_<ContainerAllocator1> & lhs, const ::gazebo_msgs::GetPhysicsPropertiesResponse_<ContainerAllocator2> & rhs)
{
