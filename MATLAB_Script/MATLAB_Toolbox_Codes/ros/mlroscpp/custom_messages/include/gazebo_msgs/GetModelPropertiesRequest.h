...
bool operator==(const ::gazebo_msgs::GetModelPropertiesRequest_<ContainerAllocator1> & lhs, const ::gazebo_msgs::GetModelPropertiesRequest_<ContainerAllocator2> & rhs)
{
