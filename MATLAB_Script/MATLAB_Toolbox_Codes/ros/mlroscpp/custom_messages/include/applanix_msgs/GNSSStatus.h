// Generated by gencpp from file applanix_msgs/GNSSStatus.msg
// DO NOT EDIT!


#ifndef APPLANIX_MSGS_MESSAGE_GNSSSTATUS_H
#define APPLANIX_MSGS_MESSAGE_GNSSSTATUS_H
...
struct GNSSStatus_
{
  ...
  enum {
    ...
    TYPE_NONE = 0u,
    TYPE_TRIMBLE_BD960 = 16u,
  };


  typedef boost::shared_ptr< ::applanix_msgs::GNSSStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::applanix_msgs::GNSSStatus_<ContainerAllocator> const> ConstPtr;

}; // struct GNSSStatus_

typedef ::applanix_msgs::GNSSStatus_<std::allocator<void> > GNSSStatus;

typedef boost::shared_ptr< ::applanix_msgs::GNSSStatus > GNSSStatusPtr;
typedef boost::shared_ptr< ::applanix_msgs::GNSSStatus const> GNSSStatusConstPtr;
...
{
ros::message_operations::Printer< ::applanix_msgs::GNSSStatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::applanix_msgs::GNSSStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::applanix_msgs::GNSSStatus_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::applanix_msgs::GNSSStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::applanix_msgs::GNSSStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::applanix_msgs::GNSSStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::applanix_msgs::GNSSStatus_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::applanix_msgs::GNSSStatus_<ContainerAllocator> >
{
  static const char* value()
  {
    return "025a8154ac59effa20d8e6dc5c1ba784";
  }

  static const char* value(const ::applanix_msgs::GNSSStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x025a8154ac59effaULL;
  static const uint64_t static_value2 = 0x20d8e6dc5c1ba784ULL;
};

template<class ContainerAllocator>
struct DataType< ::applanix_msgs::GNSSStatus_<ContainerAllocator> >
{
  static const char* value()
  {
    return "applanix_msgs/GNSSStatus";
  }
...
template<class ContainerAllocator>
struct Definition< ::applanix_msgs::GNSSStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::applanix_msgs::GNSSStatus_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::applanix_msgs::GNSSStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::applanix_msgs::GNSSStatus_<ContainerAllocator>& v)
  {
    s << indent << "td: ";
    s << std::endl;
    ...
    s << indent << "gnss_type: ";
    Printer<uint16_t>::stream(s, indent + "  ", v.gnss_type);
    s << indent << "gnss_status: ";
    Printer<uint32_t>::stream(s, indent + "  ", v.gnss_status);
  }
};
...
#endif // APPLANIX_MSGS_MESSAGE_GNSSSTATUS_H
