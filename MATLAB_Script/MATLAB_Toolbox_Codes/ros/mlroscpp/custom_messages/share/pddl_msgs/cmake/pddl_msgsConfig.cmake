...
if("FALSE" STREQUAL "TRUE")
  set(pddl_msgs_SOURCE_PREFIX /mathworks/devel/sbs/33/hakakarl.Brobot.j1784588/UpdatedCustomMessages/matlab_msg_gen_ros1/glnxa64/src/pddl_msgs)
  set(pddl_msgs_DEVEL_PREFIX /mathworks/devel/sbs/33/hakakarl.Brobot.j1784588/UpdatedCustomMessages/matlab_msg_gen_ros1/glnxa64/devel)
  ...
  set(pddl_msgs_INSTALL_PREFIX /mathworks/devel/sbs/33/hakakarl.Brobot.j1784588/UpdatedCustomMessages/matlab_msg_gen_ros1/glnxa64/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pddl_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'pddl_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT pddl_msgs_NUM_DUMMY_TARGETS)
      set(pddl_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::pddl_msgs::wrapped-linker-option${pddl_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR pddl_msgs_NUM_DUMMY_TARGETS "${pddl_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::pddl_msgs::wrapped-linker-option${pddl_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND pddl_msgs_LIBRARIES "${interface_target_name}")
...
set(pddl_msgs_EXPORTED_TARGETS "pddl_msgs_generate_messages_cpp;pddl_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(pddl_msgs_EXPORTED_TARGETS ${${pddl_msgs_dep}_EXPORTED_TARGETS})
endforeach()
