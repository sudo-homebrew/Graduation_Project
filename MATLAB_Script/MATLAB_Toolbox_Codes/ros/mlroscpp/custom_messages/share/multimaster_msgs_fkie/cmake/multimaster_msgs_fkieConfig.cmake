...
if("FALSE" STREQUAL "TRUE")
  set(multimaster_msgs_fkie_SOURCE_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/src/multimaster_msgs_fkie)
  set(multimaster_msgs_fkie_DEVEL_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/devel)
  ...
  set(multimaster_msgs_fkie_INSTALL_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multimaster_msgs_fkie' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/install/${idir}'.  ${_report}")
    endif()
...
set(multimaster_msgs_fkie_EXPORTED_TARGETS "multimaster_msgs_fkie_generate_messages_cpp;multimaster_msgs_fkie_generate_messages_py")
