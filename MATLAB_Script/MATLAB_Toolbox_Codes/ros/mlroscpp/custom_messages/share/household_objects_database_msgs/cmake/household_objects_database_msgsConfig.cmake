...
if("FALSE" STREQUAL "TRUE")
  set(household_objects_database_msgs_SOURCE_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/src/household_objects_database_msgs)
  set(household_objects_database_msgs_DEVEL_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/devel)
  ...
  set(household_objects_database_msgs_INSTALL_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'household_objects_database_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/install/${idir}'.  ${_report}")
    endif()
...
set(household_objects_database_msgs_EXPORTED_TARGETS "household_objects_database_msgs_generate_messages_cpp;household_objects_database_msgs_generate_messages_py")
...
set(depends "message_runtime;geometry_msgs;object_recognition_msgs;roscpp;shape_msgs")
