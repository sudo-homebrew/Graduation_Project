...
if("FALSE" STREQUAL "TRUE")
  set(nodelet_SOURCE_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/src/nodelet)
  set(nodelet_DEVEL_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/devel)
  set(nodelet_INSTALL_PREFIX "")
  set(nodelet_PREFIX ${nodelet_DEVEL_PREFIX})
else()
  set(nodelet_SOURCE_PREFIX "")
  set(nodelet_DEVEL_PREFIX "")
  set(nodelet_INSTALL_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nodelet' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/install/${idir}'.  ${_report}")
    endif()
...
set(nodelet_EXPORTED_TARGETS "nodelet_generate_messages_cpp;nodelet_generate_messages_py")
