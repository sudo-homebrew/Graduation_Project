...
if("FALSE" STREQUAL "TRUE")
  set(pano_ros_SOURCE_PREFIX /local-ssd1/All_Custom_Msgs/packages_in_cluster/matlab_msg_gen_ros1/glnxa64/src/pano_ros)
  set(pano_ros_DEVEL_PREFIX /local-ssd1/All_Custom_Msgs/packages_in_cluster/matlab_msg_gen_ros1/glnxa64/devel)
  set(pano_ros_INSTALL_PREFIX "")
  set(pano_ros_PREFIX ${pano_ros_DEVEL_PREFIX})
else()
  set(pano_ros_SOURCE_PREFIX "")
  set(pano_ros_DEVEL_PREFIX "")
  set(pano_ros_INSTALL_PREFIX /local-ssd1/All_Custom_Msgs/packages_in_cluster/matlab_msg_gen_ros1/glnxa64/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pano_ros' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'pano_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/local-ssd1/All_Custom_Msgs/packages_in_cluster/matlab_msg_gen_ros1/glnxa64/install/${idir}'.  ${_report}")
    endif()
...
set(pano_ros_EXPORTED_TARGETS "pano_ros_generate_messages_cpp;pano_ros_generate_messages_eus;pano_ros_generate_messages_lisp;pano_ros_generate_messages_nodejs;pano_ros_generate_messages_py")
...
set(depends "message_runtime;actionlib;roscpp;rospy;sensor_msgs;std_msgs")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${pano_ros_dep}_FOUND)
      find_package(${pano_ros_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pano_ros_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
