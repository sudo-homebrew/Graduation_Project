...
if("FALSE" STREQUAL "TRUE")
  set(rosauth_SOURCE_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/src/rosauth)
  set(rosauth_DEVEL_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/devel)
  set(rosauth_INSTALL_PREFIX "")
  set(rosauth_PREFIX ${rosauth_DEVEL_PREFIX})
else()
  set(rosauth_SOURCE_PREFIX "")
  set(rosauth_DEVEL_PREFIX "")
  set(rosauth_INSTALL_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosauth' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/install/${idir}'.  ${_report}")
    endif()
...
set(rosauth_EXPORTED_TARGETS "rosauth_generate_messages_cpp;rosauth_generate_messages_py")
