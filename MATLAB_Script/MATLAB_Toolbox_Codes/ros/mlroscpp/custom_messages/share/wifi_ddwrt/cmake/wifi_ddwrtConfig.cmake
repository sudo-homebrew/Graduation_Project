...
if("FALSE" STREQUAL "TRUE")
  set(wifi_ddwrt_SOURCE_PREFIX /local-ssd1/All_Custom_Msgs/packages_in_cluster/matlab_msg_gen_ros1/glnxa64/src/wifi_ddwrt)
  set(wifi_ddwrt_DEVEL_PREFIX /local-ssd1/All_Custom_Msgs/packages_in_cluster/matlab_msg_gen_ros1/glnxa64/devel)
  ...
  set(wifi_ddwrt_INSTALL_PREFIX /local-ssd1/All_Custom_Msgs/packages_in_cluster/matlab_msg_gen_ros1/glnxa64/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'wifi_ddwrt' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'wifi_ddwrt' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/local-ssd1/All_Custom_Msgs/packages_in_cluster/matlab_msg_gen_ros1/glnxa64/install/${idir}'.  ${_report}")
    endif()
...
set(wifi_ddwrt_EXPORTED_TARGETS "wifi_ddwrt_generate_messages_cpp;wifi_ddwrt_generate_messages_eus;wifi_ddwrt_generate_messages_lisp;wifi_ddwrt_generate_messages_nodejs;wifi_ddwrt_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${wifi_ddwrt_dep}_FOUND)
      find_package(${wifi_ddwrt_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${wifi_ddwrt_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(wifi_ddwrt_INCLUDE_DIRS ${${wifi_ddwrt_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(wifi_ddwrt_LIBRARIES ${wifi_ddwrt_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${wifi_ddwrt_dep}_LIBRARIES})
  _list_append_deduplicate(wifi_ddwrt_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(wifi_ddwrt_LIBRARIES ${wifi_ddwrt_LIBRARIES})
