...
if("FALSE" STREQUAL "TRUE")
  set(segbot_simulation_apps_SOURCE_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/src/segbot_simulation_apps)
  set(segbot_simulation_apps_DEVEL_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/devel)
  ...
  set(segbot_simulation_apps_INSTALL_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'segbot_simulation_apps' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/install/${idir}'.  ${_report}")
    endif()
...
set(segbot_simulation_apps_EXPORTED_TARGETS "segbot_simulation_apps_generate_messages_cpp;segbot_simulation_apps_generate_messages_py")
...
set(pkg_cfg_extras "segbot_simulation_apps-msg-extras.cmake")
