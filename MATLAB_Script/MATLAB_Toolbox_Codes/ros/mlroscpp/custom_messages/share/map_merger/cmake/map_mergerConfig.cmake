...
if("FALSE" STREQUAL "TRUE")
  set(map_merger_SOURCE_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/src/map_merger)
  set(map_merger_DEVEL_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/devel)
  ...
  set(map_merger_INSTALL_PREFIX /local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_merger' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/local-ssd1/AllMessages/matlab_msg_gen_ros1/glnxa64/install/${idir}'.  ${_report}")
    endif()
...
set(map_merger_EXPORTED_TARGETS "map_merger_generate_messages_cpp;map_merger_generate_messages_py")
...
set(depends "message_runtime;adhoc_communication;roscpp")
