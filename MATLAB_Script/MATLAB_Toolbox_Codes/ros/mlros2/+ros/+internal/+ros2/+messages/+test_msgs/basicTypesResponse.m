function [data, info] = basicTypesResponse
%BasicTypes gives an empty data for test_msgs/BasicTypesResponse

% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'test_msgs/BasicTypesResponse';
...
info.MessageType = 'test_msgs/BasicTypesResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
