...
%UInt32MultiArray gives an empty data for example_interfaces/UInt32MultiArray

% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'example_interfaces/UInt32MultiArray';
...
info.MessageType = 'example_interfaces/UInt32MultiArray';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
