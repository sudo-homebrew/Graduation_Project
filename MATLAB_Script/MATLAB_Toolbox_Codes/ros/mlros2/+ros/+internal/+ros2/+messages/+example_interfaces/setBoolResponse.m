...
%SetBool gives an empty data for example_interfaces/SetBoolResponse

% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'example_interfaces/SetBoolResponse';
...
info.MessageType = 'example_interfaces/SetBoolResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
