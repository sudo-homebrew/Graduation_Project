function [data, info] = setParametersRequest
%SetParameters gives an empty data for rcl_interfaces/SetParametersRequest

% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'rcl_interfaces/SetParametersRequest';
...
info.MessageType = 'rcl_interfaces/SetParametersRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
