function [data, info] = projectedMapsInfoRequest
%ProjectedMapsInfo gives an empty data for map_msgs/ProjectedMapsInfoRequest

% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'map_msgs/ProjectedMapsInfoRequest';
...
info.MessageType = 'map_msgs/ProjectedMapsInfoRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
