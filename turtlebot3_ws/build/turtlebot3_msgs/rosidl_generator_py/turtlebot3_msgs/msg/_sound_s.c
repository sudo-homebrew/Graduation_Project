...
bool turtlebot3_msgs__msg__sound__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtlebot3_msgs.msg._sound.Sound", full_classname_dest, 32) == 0);
  }
  turtlebot3_msgs__msg__Sound * ros_message = _ros_message;
  {  // value
...
PyObject * turtlebot3_msgs__msg__sound__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtlebot3_msgs.msg._sound");
